task Hunger[1200000]() // 20 PHUT
{
	foreach(new i: Player)
	{
		new doibung = 10+random(10);
		new khatnuoc = 10+random(10);

		if(PlayerInfo[i][pDoiBung] > 0 || PlayerInfo[i][pKhatNuoc] > 0)
		{
			PlayerInfo[i][pDoiBung] -= doibung;
			PlayerInfo[i][pKhatNuoc] -= khatnuoc;

			new string[1280];
			format(string, sizeof(string), "Ban da mat %d doi bung , hay di an gi do.", doibung);
			SendClientMessageEx(i, COLOR_YELLOW, string);
		}
		else
		{
		    SetPlayerHealth(i, 0);
			SendClientMessageEx(i, COLOR_YELLOW, "Ban da ngat xiu do qua doi'.");
		}
	}
}
...
timer NOPCheck[5000](playerid)
{
    ...
    else if(IsANguDanCar(newcar) && PlayerInfo[playerid][pJob] != 24 && PlayerInfo[playerid][pJob2] != 24) ExecuteNOPAction(playerid);
	else if(IsADonRacCar(newcar) && PlayerInfo[playerid][pJob] != 26 && PlayerInfo[playerid][pJob2] != 26) ExecuteNOPAction(playerid);
...
task ResetHaiCan[900000]()
{
	...
	foreach(new i: Player)
	{
		PlayerCS[pCayCanSa1] = 0;
		PlayerCS[pCayCanSa2] = 0;
		PlayerCS[pCayCanSa3] = 0;
		PlayerCS[pCayCanSa4] = 0;
		PlayerCS[pCayCanSa5] = 0;
		PlayerCS[pCayCanSa6] = 0;
	}
}
/* Repeating Timers */
...
task ProductionUpdate[300000]()
{
	...
	foreach(new i: Player)
	{
		...
		if(PlayerInfo[i][pConnectHours] < 2) {
			SendClientMessageEx(i, COLOR_LIGHTRED, "Vu khi se bi gioi han trong 2 gio choi dau tien khi tham gia may chu.");
		}
...
task TimeHuMay[180000]()
{
	{
		new may = random(10);
		new health = 30+random(20);
		...
		for(new i = 0; i < MAX_PLAYERS; i++)
		{
		    switch(may)
		    {
				case 0:
				{
				    if(TinhTrangMay1 < 100 && TinhTrangMay2 < 100 && TinhTrangMay3 < 100 && TinhTrangMay4 < 100 && TinhTrangMay5 < 100 && TinhTrangMay6 < 100 && TinhTrangMay7 < 100 && TinhTrangMay8 < 100 && TinhTrangMay9 < 100 && TinhTrangMay10 < 100)
					{
						TinhTrangMay1 += 20;
					    TinhTrangMay2 += 20;
					    TinhTrangMay3 += 20;
				...
				case 1:
				{
				    if(TinhTrangMay1 > 0)
				    {
					    TinhTrangMay1 -= health;

					    new labelmay1[1280];
						format(labelmay1, sizeof(labelmay1), "{009933}MAY DAU (( 1 )){ffffff}\nTinh Trang : %d%\nNeu tinh trang may hu hong qua nang , ban buoc phai den tien cho nha may'\nSu dung : (( {009900}ALT{ffffff} )) or (( {009900}/suangay{ffffff} )) de sua may dau khi.", TinhTrangMay1);
					    UpdateDynamic3DTextLabelText(MayDau_[0], COLOR_GREY, labelmay1);

					    if(PlayerInfo[i][pJob] == 33 || PlayerInfo[i][pJob2] == 33)
						{
					    	SendClientMessageEx(i, COLOR_GREEN, "THONG BAO : Phat hien su co tai May Dau (( 1 )) , vui long sua chua khan cap. (( /tinhtrang ))");
						}
						return 1;
					}
				    return 1;
				...
				case 2:
				{
				    if(TinhTrangMay2 > 0)
				    {
					    TinhTrangMay2 -= health;

					    new labelmay2[1280];
						format(labelmay2, sizeof(labelmay2), "{009933}MAY DAU (( 2 )){ffffff}\nTinh Trang : %d%\nNeu tinh trang may hu hong qua nang , ban buoc phai den tien cho nha may'\nSu dung : (( {009900}ALT{ffffff} )) or (( {009900}/suangay{ffffff} )) de sua may dau khi.", TinhTrangMay2);
					    UpdateDynamic3DTextLabelText(MayDau_[1], COLOR_GREY, labelmay2);

					    if(PlayerInfo[i][pJob] == 33 || PlayerInfo[i][pJob2] == 33)
						{
					    	SendClientMessageEx(i, COLOR_GREEN, "THONG BAO : Phat hien su co tai May Dau (( 2 )) , vui long sua chua khan cap. (( /tinhtrang ))");
						}
					    return 1;
				    }
				    return 1;
				...
				case 3:
				{
				    if(TinhTrangMay3 > 0)
				    {
					    TinhTrangMay3 -= health;

					    new labelmay3[1280];
						format(labelmay3, sizeof(labelmay3), "{009933}MAY DAU (( 3 )){ffffff}\nTinh Trang : %d%\nNeu tinh trang may hu hong qua nang , ban buoc phai den tien cho nha may'\nSu dung : (( {009900}ALT{ffffff} )) or (( {009900}/suangay{ffffff} )) de sua may dau khi.", TinhTrangMay3);
					    UpdateDynamic3DTextLabelText(MayDau_[2], COLOR_GREY, labelmay3);

					    if(PlayerInfo[i][pJob] == 33 || PlayerInfo[i][pJob2] == 33)
						{
					    	SendClientMessageEx(i, COLOR_GREEN, "THONG BAO : Phat hien su co tai May Dau (( 3 )) , vui long sua chua khan cap. (( /tinhtrang ))");
						}
					    return 1;
				    }
				    return 1;
				...
				case 4:
				{
				    if(TinhTrangMay4 > 0)
				    {
					    TinhTrangMay4 -= health;

					    new labelmay4[1280];
						format(labelmay4, sizeof(labelmay4), "{009933}MAY DAU (( 4 )){ffffff}\nTinh Trang : %d%\nNeu tinh trang may hu hong qua nang , ban buoc phai den tien cho nha may'\nSu dung : (( {009900}ALT{ffffff} )) or (( {009900}/suangay{ffffff} )) de sua may dau khi.", TinhTrangMay4);
					    UpdateDynamic3DTextLabelText(MayDau_[3], COLOR_GREY, labelmay4);

					    if(PlayerInfo[i][pJob] == 33 || PlayerInfo[i][pJob2] == 33)
						{
					    	SendClientMessageEx(i, COLOR_GREEN, "THONG BAO : Phat hien su co tai May Dau (( 4 )) , vui long sua chua khan cap. (( /tinhtrang ))");
						}
					    return 1;
				    }
				    return 1;
				...
				case 5:
				{
				    if(TinhTrangMay5 > 0)
				    {
					    TinhTrangMay5 -= health;

					    new labelmay5[1280];
						format(labelmay5, sizeof(labelmay5), "{009933}MAY DAU (( 5 )){ffffff}\nTinh Trang : %d%\nNeu tinh trang may hu hong qua nang , ban buoc phai den tien cho nha may'\nSu dung : (( {009900}ALT{ffffff} )) or (( {009900}/suangay{ffffff} )) de sua may dau khi.", TinhTrangMay5);
					    UpdateDynamic3DTextLabelText(MayDau_[4], COLOR_GREY, labelmay5);

					    if(PlayerInfo[i][pJob] == 33 || PlayerInfo[i][pJob2] == 33)
						{
					    	SendClientMessageEx(i, COLOR_GREEN, "THONG BAO : Phat hien su co tai May Dau (( 5 )) , vui long sua chua khan cap. (( /tinhtrang ))");
						}
					    return 1;
				    }
				    return 1;
				...
				case 6:
				{
				    if(TinhTrangMay6 > 0)
				    {
					    TinhTrangMay6 -= health;

					    new labelmay6[1280];
						format(labelmay6, sizeof(labelmay6), "{009933}MAY DAU (( 6 )){ffffff}\nTinh Trang : %d%\nNeu tinh trang may hu hong qua nang , ban buoc phai den tien cho nha may'\nSu dung : (( {009900}ALT{ffffff} )) or (( {009900}/suangay{ffffff} )) de sua may dau khi.", TinhTrangMay6);
					    UpdateDynamic3DTextLabelText(MayDau_[5], COLOR_GREY, labelmay6);

					    if(PlayerInfo[i][pJob] == 33 || PlayerInfo[i][pJob2] == 33)
						{
					    	SendClientMessageEx(i, COLOR_GREEN, "THONG BAO : Phat hien su co tai May Dau (( 6 )) , vui long sua chua khan cap. (( /tinhtrang ))");
						}
					    return 1;
				    }
				    return 1;
				...
				case 7:
				{
				    if(TinhTrangMay7 > 0)
				    {
					    TinhTrangMay7 -= health;

					    new labelmay7[1280];
						format(labelmay7, sizeof(labelmay7), "{009933}MAY DAU (( 7 )){ffffff}\nTinh Trang : %d%\nNeu tinh trang may hu hong qua nang , ban buoc phai den tien cho nha may'\nSu dung : (( {009900}ALT{ffffff} )) or (( {009900}/suangay{ffffff} )) de sua may dau khi.", TinhTrangMay7);
					    UpdateDynamic3DTextLabelText(MayDau_[6], COLOR_GREY, labelmay7);

					    if(PlayerInfo[i][pJob] == 33 || PlayerInfo[i][pJob2] == 33)
						{
					    	SendClientMessageEx(i, COLOR_GREEN, "THONG BAO : Phat hien su co tai May Dau (( 7 )) , vui long sua chua khan cap. (( /tinhtrang ))");
						}
					    return 1;
				    }
				    return 1;
				...
				case 8:
				{
				    if(TinhTrangMay8 > 0)
				    {
					    TinhTrangMay8 -= health;

					    new labelmay8[1280];
						format(labelmay8, sizeof(labelmay8), "{009933}MAY DAU (( 8 )){ffffff}\nTinh Trang : %d%\nNeu tinh trang may hu hong qua nang , ban buoc phai den tien cho nha may'\nSu dung : (( {009900}ALT{ffffff} )) or (( {009900}/suangay{ffffff} )) de sua may dau khi.", TinhTrangMay8);
					    UpdateDynamic3DTextLabelText(MayDau_[7], COLOR_GREY, labelmay8);

					    if(PlayerInfo[i][pJob] == 33 || PlayerInfo[i][pJob2] == 33)
						{
					    	SendClientMessageEx(i, COLOR_GREEN, "THONG BAO : Phat hien su co tai May Dau (( 8 )) , vui long sua chua khan cap. (( /tinhtrang ))");
						}
					    return 1;
				    }
				    return 1;
				...
				case 9:
				{
				    if(TinhTrangMay9 > 0)
				    {
					    TinhTrangMay9 -= health;

					    new labelmay9[1280];
						format(labelmay9, sizeof(labelmay9), "{009933}MAY DAU (( 9 )){ffffff}\nTinh Trang : %d%\nNeu tinh trang may hu hong qua nang , ban buoc phai den tien cho nha may'\nSu dung : (( {009900}ALT{ffffff} )) or (( {009900}/suangay{ffffff} )) de sua may dau khi.", TinhTrangMay9);
					    UpdateDynamic3DTextLabelText(MayDau_[8], COLOR_GREY, labelmay9);

					    SendClientMessageEx(i, COLOR_GREEN, "THONG BAO : Phat hien su co tai May Dau (( 9 )) , vui long sua chua khan cap. (( /tinhtrang ))");
					    return 1;
				    }
				    return 1;
				}
				case 10:
				{
					if(TinhTrangMay10 > 0)
					{
					    TinhTrangMay10 -= health;

					    new labelmay10[1280];
						format(labelmay10, sizeof(labelmay10), "{009933}MAY DAU (( 10 )){ffffff}\nTinh Trang : %d%\nNeu tinh trang may hu hong qua nang , ban buoc phai den tien cho nha may'\nSu dung : (( {009900}ALT{ffffff} )) or (( {009900}/suangay{ffffff} )) de sua may dau khi.", TinhTrangMay10);
					    UpdateDynamic3DTextLabelText(MayDau_[9], COLOR_GREY, labelmay10);

					    if(PlayerInfo[i][pJob] == 33 || PlayerInfo[i][pJob2] == 33)
						{
					    	SendClientMessageEx(i, COLOR_GREEN, "THONG BAO : Phat hien su co tai May Dau (( 10 )) , vui long sua chua khan cap. (( /tinhtrang ))");
						}
					    return 1;
				    }
				    return 1;
	...
	foreach(new i: Player)
	{
		...
		*/
		    ...
		    if(PlayerInfo[i][Robbing] == 1 && PlayerInfo[i][CashLoading] != 0)
			{
			   ...
			   {
			       PlayerInfo[i][CashLoaded] += 5000;
			   	   SendClientMessage(i, COLOR_YELLOW, "** Ban da co them $5,000 trong Tui Tien cua ban.");
				   if(PlayerInfo[i][CashLoaded] >= 25000)
				   {
				       PlayerInfo[i][CashLoaded] = 25000;
				       SendClientMessage(i, COLOR_YELLOW, "** Ban khong the dat lon hon $25,000 trong tui cua ban.");
				   }
			   }
			}
	...
	foreach(new i: Player)
	{
	    ...
	    if(GetPVarType(i, "Injured"))
	    {
	        ...
	        if(GetPVarInt(i, "EMSAttempt") != 0)
			{
				...
				{
					if(GetPlayerAnimationIndex(i) != 1071) ClearAnimations(i), ApplyAnimation(i, "WUZI", "CS_Dead_Guy", 4.0, 0, 1, 1, 1, 0, 1);
                    ...
                    new string[200];
                    format(string, sizeof(string), "(( Anh ta dang bi thuong , hay giup anh ta goi cap cuu ))");
                    SetPlayerChatBubble(i,string,COLOR_LIGHTRED,50.0,10000);
				}
				if(GetPVarInt(i, "EMSAttempt") == 1)
				{
					if(GetPlayerAnimationIndex(i) != 1071) ClearAnimations(i), ApplyAnimation(i, "WUZI", "CS_Dead_Guy", 4.0, 0, 1, 1, 1, 0, 1);
