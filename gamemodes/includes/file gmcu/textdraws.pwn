...
{
    nDPDz[0] = TextDrawCreate(6.000010, 176.570373, "hud:radar_burgerShot");
	TextDrawLetterSize(nDPDz[0], 0.000000, 0.000000);
	TextDrawTextSize(nDPDz[0], 18.000000, 19.000000);
	TextDrawAlignment(nDPDz[0], 1);
	TextDrawColor(nDPDz[0], -1);
	TextDrawSetShadow(nDPDz[0], 0);
	TextDrawSetOutline(nDPDz[0], 0);
	TextDrawBackgroundColor(nDPDz[0], 255);
	TextDrawFont(nDPDz[0], 4);
	TextDrawSetProportional(nDPDz[0], 0);
	TextDrawSetShadow(nDPDz[0], 0);

	nDPDz[1] = TextDrawCreate(7.000009, 209.340667, "hud:radar_dateDrink");
	TextDrawLetterSize(nDPDz[1], 0.000000, 0.000000);
	TextDrawTextSize(nDPDz[1], 15.000000, 17.000000);
	TextDrawAlignment(nDPDz[1], 1);
	TextDrawColor(nDPDz[1], -1);
	TextDrawSetShadow(nDPDz[1], 0);
	TextDrawSetOutline(nDPDz[1], 0);
	TextDrawBackgroundColor(nDPDz[1], 255);
	TextDrawFont(nDPDz[1], 4);
	TextDrawSetProportional(nDPDz[1], 0);
	TextDrawSetShadow(nDPDz[1], 0);


    TextDraw_1[0] = TextDrawCreate(560.333312, 2.503663, "Wolrp");
	TextDrawLetterSize(TextDraw_1[0], 0.528333, 1.898666);
	TextDrawAlignment(TextDraw_1[0], 1);
	TextDrawColor(TextDraw_1[0], -5963521);
	TextDrawSetShadow(TextDraw_1[0], 0);
	TextDrawSetOutline(TextDraw_1[0], 1);
	TextDrawBackgroundColor(TextDraw_1[0], 255);
	TextDrawFont(TextDraw_1[0], 2);
	TextDrawSetProportional(TextDraw_1[0], 1);
	TextDrawSetShadow(TextDraw_1[0], 0);

	TextDraw_1[1] = TextDrawCreate(563.000122, 20.340864, "box");
	TextDrawLetterSize(TextDraw_1[1], 0.000000, -0.166667);
	TextDrawTextSize(TextDraw_1[1], 632.000000, 0.000000);
	TextDrawAlignment(TextDraw_1[1], 1);
	TextDrawColor(TextDraw_1[1], -5963521);
	TextDrawUseBox(TextDraw_1[1], 1);
	TextDrawBoxColor(TextDraw_1[1], 255);
	TextDrawSetShadow(TextDraw_1[1], 0);
	TextDrawSetOutline(TextDraw_1[1], 0);
	TextDrawBackgroundColor(TextDraw_1[1], 255);
	TextDrawFont(TextDraw_1[1], 1);
	TextDrawSetProportional(TextDraw_1[1], 1);
	TextDrawSetShadow(TextDraw_1[1], 0);

	TextDraw_1[2] = TextDrawCreate(570.333312, 21.585193, "mobile_2021");
	TextDrawLetterSize(TextDraw_1[2], 0.196999, 0.670814);
	TextDrawAlignment(TextDraw_1[2], 1);
	TextDrawColor(TextDraw_1[2], -1523963137);
	TextDrawSetShadow(TextDraw_1[2], 0);
	TextDrawSetOutline(TextDraw_1[2], 1);
	TextDrawBackgroundColor(TextDraw_1[2], 255);
	TextDrawFont(TextDraw_1[2], 2);
	TextDrawSetProportional(TextDraw_1[2], 1);
	TextDrawSetShadow(TextDraw_1[2], 0);

	TextDraw_1[3] = TextDrawCreate(520.666748, 10.385194, "6/8/2021");
	TextDrawLetterSize(TextDraw_1[3], 0.236000, 0.604444);
	TextDrawAlignment(TextDraw_1[3], 1);
	TextDrawColor(TextDraw_1[3], -1378294017);
	TextDrawSetShadow(TextDraw_1[3], 0);
	TextDrawSetOutline(TextDraw_1[3], 1);
	TextDrawBackgroundColor(TextDraw_1[3], 255);
	TextDrawFont(TextDraw_1[3], 3);
	TextDrawSetProportional(TextDraw_1[3], 1);
	TextDrawSetShadow(TextDraw_1[3], 0);

	TextDraw_1[4] = TextDrawCreate(529.000061, 19.096303, "9:30");
	TextDrawLetterSize(TextDraw_1[4], 0.236000, 0.604444);
	TextDrawAlignment(TextDraw_1[4], 1);
	TextDrawColor(TextDraw_1[4], -1378294017);
	TextDrawSetShadow(TextDraw_1[4], 0);
	TextDrawSetOutline(TextDraw_1[4], 1);
	TextDrawBackgroundColor(TextDraw_1[4], 255);
	TextDrawFont(TextDraw_1[4], 3);
	TextDrawSetProportional(TextDraw_1[4], 1);
	TextDrawSetShadow(TextDraw_1[4], 0);

	TextDraw_1[5] = TextDrawCreate(4.999989, 431.837066, "box");
	TextDrawLetterSize(TextDraw_1[5], 0.000000, 0.800000);
	TextDrawTextSize(TextDraw_1[5], 24.000000, 0.000000);
	TextDrawAlignment(TextDraw_1[5], 1);
	TextDrawColor(TextDraw_1[5], -1);
	TextDrawUseBox(TextDraw_1[5], 1);
	TextDrawBoxColor(TextDraw_1[5], 255);
	TextDrawSetShadow(TextDraw_1[5], 0);
	TextDrawSetOutline(TextDraw_1[5], 0);
	TextDrawBackgroundColor(TextDraw_1[5], 255);
	TextDrawFont(TextDraw_1[5], 2);
	TextDrawSetProportional(TextDraw_1[5], 1);
	TextDrawSetShadow(TextDraw_1[5], 0);

	TextDraw_1[6] = TextDrawCreate(5.000000, 441.377685, "box");
	TextDrawLetterSize(TextDraw_1[6], 0.000000, -0.133333);
	TextDrawTextSize(TextDraw_1[6], 24.000000, 0.000000);
	TextDrawAlignment(TextDraw_1[6], 1);
	TextDrawColor(TextDraw_1[6], -1);
	TextDrawUseBox(TextDraw_1[6], 1);
	TextDrawBoxColor(TextDraw_1[6], -5963521);
	TextDrawSetShadow(TextDraw_1[6], 0);
	TextDrawSetOutline(TextDraw_1[6], 0);
	TextDrawBackgroundColor(TextDraw_1[6], 255);
	TextDrawFont(TextDraw_1[6], 2);
	TextDrawSetProportional(TextDraw_1[6], 1);
	TextDrawSetShadow(TextDraw_1[6], 0);

	TextDraw_1[7] = TextDrawCreate(31.333335, 431.837036, "box");
	TextDrawLetterSize(TextDraw_1[7], -0.001666, 0.804148);
	TextDrawTextSize(TextDraw_1[7], 64.000000, 0.000000);
	TextDrawAlignment(TextDraw_1[7], 1);
	TextDrawColor(TextDraw_1[7], -1);
	TextDrawUseBox(TextDraw_1[7], 1);
	TextDrawBoxColor(TextDraw_1[7], 255);
	TextDrawSetShadow(TextDraw_1[7], 0);
	TextDrawSetOutline(TextDraw_1[7], 0);
	TextDrawBackgroundColor(TextDraw_1[7], 255);
	TextDrawFont(TextDraw_1[7], 2);
	TextDrawSetProportional(TextDraw_1[7], 1);
	TextDrawSetShadow(TextDraw_1[7], 0);

	TextDraw_1[8] = TextDrawCreate(31.333335, 431.837036, "box");
	TextDrawLetterSize(TextDraw_1[8], -0.001666, 0.804148);
	TextDrawTextSize(TextDraw_1[8], 31.000000, 0.000000);
	TextDrawAlignment(TextDraw_1[8], 1);
	TextDrawColor(TextDraw_1[8], -1);
	TextDrawUseBox(TextDraw_1[8], 1);
	TextDrawBoxColor(TextDraw_1[8], -5963521);
	TextDrawSetShadow(TextDraw_1[8], 0);
	TextDrawSetOutline(TextDraw_1[8], -12);
	TextDrawBackgroundColor(TextDraw_1[8], 255);
	TextDrawFont(TextDraw_1[8], 2);
	TextDrawSetProportional(TextDraw_1[8], 1);
	TextDrawSetShadow(TextDraw_1[8], 0);
	...
	// NG-RP Title
	MainMenuTxtdraw[4] = TextDrawCreate(263.000000, 10.000000, SERVER_GM_TEXT);
	...
	NoticeTxtdraw[1] = TextDrawCreate(317.000000, 174.000000, "WOLRP - Notice");
	...
	for(new i; i < MAX_PLAYERS; i ++)
	{
	    ...
	    DLTextDraws[0][i] = TextDrawCreate(320.000000, 132.000000, "_");
		TextDrawAlignment(DLTextDraws[0][i], 2);
		TextDrawBackgroundColor(DLTextDraws[0][i], 255);
		TextDrawFont(DLTextDraws[0][i], 1);
		TextDrawLetterSize(DLTextDraws[0][i], 0.500000, 23.100000);
		TextDrawColor(DLTextDraws[0][i], -1);
		TextDrawSetOutline(DLTextDraws[0][i], 0);
		TextDrawSetProportional(DLTextDraws[0][i], 1);
		TextDrawSetShadow(DLTextDraws[0][i], 1);
		TextDrawUseBox(DLTextDraws[0][i], 1);
		TextDrawBoxColor(DLTextDraws[0][i], 90);
		TextDrawTextSize(DLTextDraws[0][i], 318.000000, 421.000000);
		TextDrawSetSelectable(DLTextDraws[0][i], 0);

		DLTextDraws[1][i] = TextDrawCreate(524.000000, 116.000000, "_");
		TextDrawAlignment(DLTextDraws[1][i], 2);
		TextDrawBackgroundColor(DLTextDraws[1][i], 255);
		TextDrawFont(DLTextDraws[1][i], 1);
		TextDrawLetterSize(DLTextDraws[1][i], 0.500000, 1.399999);
		TextDrawColor(DLTextDraws[1][i], -1);
		TextDrawSetOutline(DLTextDraws[1][i], 0);
		TextDrawSetProportional(DLTextDraws[1][i], 1);
		TextDrawSetShadow(DLTextDraws[1][i], 1);
		TextDrawUseBox(DLTextDraws[1][i], 1);
		TextDrawBoxColor(DLTextDraws[1][i], 90);
		TextDrawTextSize(DLTextDraws[1][i], 318.000000, 13.000000);
		TextDrawSetSelectable(DLTextDraws[1][i], 0);

		DLTextDraws[2][i] = TextDrawCreate(517.000000, 112.000000, "X");
		TextDrawBackgroundColor(DLTextDraws[2][i], 255);
		TextDrawFont(DLTextDraws[2][i], 2);
		TextDrawLetterSize(DLTextDraws[2][i], 0.519999, 2.000000);
		TextDrawColor(DLTextDraws[2][i], -932957496);
		TextDrawSetOutline(DLTextDraws[2][i], 0);
		TextDrawSetProportional(DLTextDraws[2][i], 1);
		TextDrawSetShadow(DLTextDraws[2][i], 1);
		TextDrawTextSize(DLTextDraws[2][i], 530.000000, 18.000000);
		TextDrawSetSelectable(DLTextDraws[2][i], 1);

		DLTextDraws[3][i] = TextDrawCreate(190.000000, 212.000000, "_");
		TextDrawAlignment(DLTextDraws[3][i], 2);
		TextDrawBackgroundColor(DLTextDraws[3][i], 255);
		TextDrawFont(DLTextDraws[3][i], 1);
		TextDrawLetterSize(DLTextDraws[3][i], 0.500000, 9.100000);
		TextDrawColor(DLTextDraws[3][i], -1);
		TextDrawSetOutline(DLTextDraws[3][i], 0);
		TextDrawSetProportional(DLTextDraws[3][i], 1);
		TextDrawSetShadow(DLTextDraws[3][i], 1);
		TextDrawUseBox(DLTextDraws[3][i], 1);
		TextDrawBoxColor(DLTextDraws[3][i], 90);
		TextDrawTextSize(DLTextDraws[3][i], 318.000000, 111.000000);
		TextDrawSetSelectable(DLTextDraws[3][i], 0);

		DLTextDraws[4][i] = TextDrawCreate(320.000000, 192.000000, "_");
		TextDrawAlignment(DLTextDraws[4][i], 2);
		TextDrawBackgroundColor(DLTextDraws[4][i], 255);
		TextDrawFont(DLTextDraws[4][i], 1);
		TextDrawLetterSize(DLTextDraws[4][i], 0.500000, 13.100000);
		TextDrawColor(DLTextDraws[4][i], -1);
		TextDrawSetOutline(DLTextDraws[4][i], 0);
		TextDrawSetProportional(DLTextDraws[4][i], 1);
		TextDrawSetShadow(DLTextDraws[4][i], 1);
		TextDrawUseBox(DLTextDraws[4][i], 1);
		TextDrawBoxColor(DLTextDraws[4][i], 90);
		TextDrawTextSize(DLTextDraws[4][i], 318.000000, 131.000000);
		TextDrawSetSelectable(DLTextDraws[4][i], 0);

		DLTextDraws[5][i] = TextDrawCreate(450.000000, 212.000000, "_");
		TextDrawAlignment(DLTextDraws[5][i], 2);
		TextDrawBackgroundColor(DLTextDraws[5][i], 255);
		TextDrawFont(DLTextDraws[5][i], 1);
		TextDrawLetterSize(DLTextDraws[5][i], 0.500000, 9.100000);
		TextDrawColor(DLTextDraws[5][i], -1);
		TextDrawSetOutline(DLTextDraws[5][i], 0);
		TextDrawSetProportional(DLTextDraws[5][i], 1);
		TextDrawSetShadow(DLTextDraws[5][i], 1);
		TextDrawUseBox(DLTextDraws[5][i], 1);
		TextDrawBoxColor(DLTextDraws[5][i], 90);
		TextDrawTextSize(DLTextDraws[5][i], 318.000000, 111.000000);
		TextDrawSetSelectable(DLTextDraws[5][i], 0);

		DLTextDraws[6][i] = TextDrawCreate(224.000000, 166.000000, "Members");
		TextDrawBackgroundColor(DLTextDraws[6][i], 0);
		TextDrawFont(DLTextDraws[6][i], 5);
		TextDrawLetterSize(DLTextDraws[6][i], 0.500000, 1.000000);
		TextDrawColor(DLTextDraws[6][i], -1);
		TextDrawSetOutline(DLTextDraws[6][i], 0);
		TextDrawSetProportional(DLTextDraws[6][i], 1);
		TextDrawSetShadow(DLTextDraws[6][i], 1);
		TextDrawUseBox(DLTextDraws[6][i], 1);
		TextDrawBoxColor(DLTextDraws[6][i], 0);
		TextDrawTextSize(DLTextDraws[6][i], 190.000000, 165.000000);
		TextDrawSetPreviewModel(DLTextDraws[6][i], 19054);
		TextDrawSetPreviewRot(DLTextDraws[6][i], -45.000000, 0.000000, 0.000000, 1.000000);
		TextDrawSetSelectable(DLTextDraws[6][i], 0);

		DLTextDraws[7][i] = TextDrawCreate(111.000000, 190.000000, "VIPBronze");
		TextDrawBackgroundColor(DLTextDraws[7][i], 0);
		TextDrawFont(DLTextDraws[7][i], 5);
		TextDrawLetterSize(DLTextDraws[7][i], 0.500000, 1.000000);
		TextDrawColor(DLTextDraws[7][i], -1);
		TextDrawSetOutline(DLTextDraws[7][i], 0);
		TextDrawSetProportional(DLTextDraws[7][i], 1);
		TextDrawSetShadow(DLTextDraws[7][i], 1);
		TextDrawUseBox(DLTextDraws[7][i], 1);
		TextDrawBoxColor(DLTextDraws[7][i], 0);
		TextDrawTextSize(DLTextDraws[7][i], 157.000000, 120.000000);
		TextDrawSetPreviewModel(DLTextDraws[7][i], 19055);
		TextDrawSetPreviewRot(DLTextDraws[7][i], -45.000000, 0.000000, 0.000000, 1.000000);
		TextDrawSetSelectable(DLTextDraws[7][i], 0);

		DLTextDraws[8][i] = TextDrawCreate(371.000000, 190.000000, "VIPSilver");
		TextDrawBackgroundColor(DLTextDraws[8][i], 0);
		TextDrawFont(DLTextDraws[8][i], 5);
		TextDrawLetterSize(DLTextDraws[8][i], 0.500000, 1.000000);
		TextDrawColor(DLTextDraws[8][i], -1);
		TextDrawSetOutline(DLTextDraws[8][i], 0);
		TextDrawSetProportional(DLTextDraws[8][i], 1);
		TextDrawSetShadow(DLTextDraws[8][i], 1);
		TextDrawUseBox(DLTextDraws[8][i], 1);
		TextDrawBoxColor(DLTextDraws[8][i], 0);
		TextDrawTextSize(DLTextDraws[8][i], 157.000000, 120.000000);
		TextDrawSetPreviewModel(DLTextDraws[8][i], 19057);
		TextDrawSetPreviewRot(DLTextDraws[8][i], -45.000000, 0.000000, 0.000000, 1.000000);
		TextDrawSetSelectable(DLTextDraws[8][i], 0);

		DLTextDraws[9][i] = TextDrawCreate(253.000000, 316.000000, "ld_spac:white");
		TextDrawBackgroundColor(DLTextDraws[9][i], 255);
		TextDrawFont(DLTextDraws[9][i], 4);
		TextDrawLetterSize(DLTextDraws[9][i], 0.500000, 1.000000);
		TextDrawColor(DLTextDraws[9][i], -16776961);
		TextDrawSetOutline(DLTextDraws[9][i], 0);
		TextDrawSetProportional(DLTextDraws[9][i], 1);
		TextDrawSetShadow(DLTextDraws[9][i], 1);
		TextDrawUseBox(DLTextDraws[9][i], 1);
		TextDrawBoxColor(DLTextDraws[9][i], 0);
		TextDrawTextSize(DLTextDraws[9][i], 134.000000, 21.000000);
		TextDrawSetSelectable(DLTextDraws[9][i], 0);

		DLTextDraws[10][i] = TextDrawCreate(133.000000, 316.000000, "ld_spac:white");
		TextDrawBackgroundColor(DLTextDraws[10][i], 255);
		TextDrawFont(DLTextDraws[10][i], 4);
		TextDrawLetterSize(DLTextDraws[10][i], 0.500000, 1.000000);
		TextDrawColor(DLTextDraws[10][i], -16776961);
		TextDrawSetOutline(DLTextDraws[10][i], 0);
		TextDrawSetProportional(DLTextDraws[10][i], 1);
		TextDrawSetShadow(DLTextDraws[10][i], 1);
		TextDrawUseBox(DLTextDraws[10][i], 1);
		TextDrawBoxColor(DLTextDraws[10][i], 0);
		TextDrawTextSize(DLTextDraws[10][i], 114.000000, 21.000000);
		TextDrawSetSelectable(DLTextDraws[10][i], 0);

		DLTextDraws[11][i] = TextDrawCreate(393.000000, 316.000000, "ld_spac:white");
		TextDrawBackgroundColor(DLTextDraws[11][i], 255);
		TextDrawFont(DLTextDraws[11][i], 4);
		TextDrawLetterSize(DLTextDraws[11][i], 0.500000, 1.000000);
		TextDrawColor(DLTextDraws[11][i], -16776961);
		TextDrawSetOutline(DLTextDraws[11][i], 0);
		TextDrawSetProportional(DLTextDraws[11][i], 1);
		TextDrawSetShadow(DLTextDraws[11][i], 1);
		TextDrawUseBox(DLTextDraws[11][i], 1);
		TextDrawBoxColor(DLTextDraws[11][i], 0);
		TextDrawTextSize(DLTextDraws[11][i], 114.000000, 21.000000);
		TextDrawSetSelectable(DLTextDraws[11][i], 0);

		DLTextDraws[12][i] = TextDrawCreate(254.000000, 317.000000, "ld_spac:white");
		TextDrawBackgroundColor(DLTextDraws[12][i], 255);
		TextDrawFont(DLTextDraws[12][i], 4);
		TextDrawLetterSize(DLTextDraws[12][i], 0.500000, 1.000000);
		TextDrawColor(DLTextDraws[12][i], 255);
		TextDrawSetOutline(DLTextDraws[12][i], 0);
		TextDrawSetProportional(DLTextDraws[12][i], 1);
		TextDrawSetShadow(DLTextDraws[12][i], 1);
		TextDrawUseBox(DLTextDraws[12][i], 1);
		TextDrawBoxColor(DLTextDraws[12][i], 0);
		TextDrawTextSize(DLTextDraws[12][i], 132.000000, 19.000000);
		TextDrawSetSelectable(DLTextDraws[12][i], 1);

		DLTextDraws[13][i] = TextDrawCreate(134.000000, 317.000000, "ld_spac:white");
		TextDrawBackgroundColor(DLTextDraws[13][i], 255);
		TextDrawFont(DLTextDraws[13][i], 4);
		TextDrawLetterSize(DLTextDraws[13][i], 0.500000, 1.000000);
		TextDrawColor(DLTextDraws[13][i], 255);
		TextDrawSetOutline(DLTextDraws[13][i], 0);
		TextDrawSetProportional(DLTextDraws[13][i], 1);
		TextDrawSetShadow(DLTextDraws[13][i], 1);
		TextDrawUseBox(DLTextDraws[13][i], 1);
		TextDrawBoxColor(DLTextDraws[13][i], 0);
		TextDrawTextSize(DLTextDraws[13][i], 112.000000, 19.000000);
		TextDrawSetSelectable(DLTextDraws[13][i], 1);

		DLTextDraws[14][i] = TextDrawCreate(394.000000, 317.000000, "ld_spac:white");
		TextDrawBackgroundColor(DLTextDraws[14][i], 255);
		TextDrawFont(DLTextDraws[14][i], 4);
		TextDrawLetterSize(DLTextDraws[14][i], 0.500000, 1.000000);
		TextDrawColor(DLTextDraws[14][i], 255);
		TextDrawSetOutline(DLTextDraws[14][i], 0);
		TextDrawSetProportional(DLTextDraws[14][i], 1);
		TextDrawSetShadow(DLTextDraws[14][i], 1);
		TextDrawUseBox(DLTextDraws[14][i], 1);
		TextDrawBoxColor(DLTextDraws[14][i], 0);
		TextDrawTextSize(DLTextDraws[14][i], 112.000000, 19.000000);
		TextDrawSetSelectable(DLTextDraws[14][i], 1);

		DLTextDraws[15][i] = TextDrawCreate(183.000000, 298.000000, "ld_chat:thumbup");
		TextDrawBackgroundColor(DLTextDraws[15][i], 255);
		TextDrawFont(DLTextDraws[15][i], 4);
		TextDrawLetterSize(DLTextDraws[15][i], 0.500000, 1.000000);
		TextDrawColor(DLTextDraws[15][i], -1);
		TextDrawSetOutline(DLTextDraws[15][i], 0);
		TextDrawSetProportional(DLTextDraws[15][i], 1);
		TextDrawSetShadow(DLTextDraws[15][i], 1);
		TextDrawUseBox(DLTextDraws[15][i], 1);
		TextDrawBoxColor(DLTextDraws[15][i], 255);
		TextDrawTextSize(DLTextDraws[15][i], 15.000000, 15.000000);
		TextDrawSetSelectable(DLTextDraws[15][i], 0);

		DLTextDraws[16][i] = TextDrawCreate(443.000000, 298.000000, "ld_chat:thumbdn");
		TextDrawBackgroundColor(DLTextDraws[16][i], 255);
		TextDrawFont(DLTextDraws[16][i], 4);
		TextDrawLetterSize(DLTextDraws[16][i], 0.500000, 1.000000);
		TextDrawColor(DLTextDraws[16][i], -1);
		TextDrawSetOutline(DLTextDraws[16][i], 0);
		TextDrawSetProportional(DLTextDraws[16][i], 1);
		TextDrawSetShadow(DLTextDraws[16][i], 1);
		TextDrawUseBox(DLTextDraws[16][i], 1);
		TextDrawBoxColor(DLTextDraws[16][i], 255);
		TextDrawTextSize(DLTextDraws[16][i], 15.000000, 15.000000);
		TextDrawSetSelectable(DLTextDraws[16][i], 0);

		DLTextDraws[17][i] = TextDrawCreate(320.000000, 173.000000, "Qua hang ngay");
		TextDrawAlignment(DLTextDraws[17][i], 2);
		TextDrawBackgroundColor(DLTextDraws[17][i], 255);
		TextDrawFont(DLTextDraws[17][i], 3);
		TextDrawLetterSize(DLTextDraws[17][i], 0.300000, 1.399999);
		TextDrawColor(DLTextDraws[17][i], 13133000);
		TextDrawSetOutline(DLTextDraws[17][i], 0);
		TextDrawSetProportional(DLTextDraws[17][i], 1);
		TextDrawSetShadow(DLTextDraws[17][i], 1);
		TextDrawSetSelectable(DLTextDraws[17][i], 0);

		DLTextDraws[18][i] = TextDrawCreate(190.000000, 192.000000, "VIP Bonus: Bronze");
		TextDrawAlignment(DLTextDraws[18][i], 2);
		TextDrawBackgroundColor(DLTextDraws[18][i], 255);
		TextDrawFont(DLTextDraws[18][i], 3);
		TextDrawLetterSize(DLTextDraws[18][i], 0.300000, 1.399999);
		TextDrawColor(DLTextDraws[18][i], 13133000);
		TextDrawSetOutline(DLTextDraws[18][i], 0);
		TextDrawSetProportional(DLTextDraws[18][i], 1);
		TextDrawSetShadow(DLTextDraws[18][i], 1);
		TextDrawSetSelectable(DLTextDraws[18][i], 0);

		DLTextDraws[19][i] = TextDrawCreate(450.000000, 192.000000, "VIP Bonus: Silver");
		TextDrawAlignment(DLTextDraws[19][i], 2);
		TextDrawBackgroundColor(DLTextDraws[19][i], 255);
		TextDrawFont(DLTextDraws[19][i], 3);
		TextDrawLetterSize(DLTextDraws[19][i], 0.300000, 1.399999);
		TextDrawColor(DLTextDraws[19][i], 13133000);
		TextDrawSetOutline(DLTextDraws[19][i], 0);
		TextDrawSetProportional(DLTextDraws[19][i], 1);
		TextDrawSetShadow(DLTextDraws[19][i], 1);
		TextDrawSetSelectable(DLTextDraws[19][i], 0);

		DLTextDraws[20][i] = TextDrawCreate(320.000000, 132.000000, "_");
		TextDrawAlignment(DLTextDraws[20][i], 2);
		TextDrawBackgroundColor(DLTextDraws[20][i], 255);
		TextDrawFont(DLTextDraws[20][i], 1);
		TextDrawLetterSize(DLTextDraws[20][i], 0.500000, 1.899999);
		TextDrawColor(DLTextDraws[20][i], -1);
		TextDrawSetOutline(DLTextDraws[20][i], 0);
		TextDrawSetProportional(DLTextDraws[20][i], 1);
		TextDrawSetShadow(DLTextDraws[20][i], 1);
		TextDrawUseBox(DLTextDraws[20][i], 1);
		TextDrawBoxColor(DLTextDraws[20][i], 90);
		TextDrawTextSize(DLTextDraws[20][i], 318.000000, 421.000000);
		TextDrawSetSelectable(DLTextDraws[20][i], 0);

		DLTextDraws[21][i] = TextDrawCreate(319.000000, 130.000000, "Qua tang hang ngay");
		TextDrawAlignment(DLTextDraws[21][i], 2);
		TextDrawBackgroundColor(DLTextDraws[21][i], 255);
		TextDrawFont(DLTextDraws[21][i], 2);
		TextDrawLetterSize(DLTextDraws[21][i], 0.500000, 2.000000);
		TextDrawColor(DLTextDraws[21][i], -932957496);
		TextDrawSetOutline(DLTextDraws[21][i], 0);
		TextDrawSetProportional(DLTextDraws[21][i], 1);
		TextDrawSetShadow(DLTextDraws[21][i], 1);
		TextDrawSetSelectable(DLTextDraws[21][i], 0);

		DLTextDraws[22][i] = TextDrawCreate(320.000000, 319.000000, "Mo hop qua");
		TextDrawAlignment(DLTextDraws[22][i], 2);
		TextDrawBackgroundColor(DLTextDraws[22][i], 255);
		TextDrawFont(DLTextDraws[22][i], 3);
		TextDrawLetterSize(DLTextDraws[22][i], 0.300000, 1.399999);
		TextDrawColor(DLTextDraws[22][i], 13133000);
		TextDrawSetOutline(DLTextDraws[22][i], 0);
		TextDrawSetProportional(DLTextDraws[22][i], 1);
		TextDrawSetShadow(DLTextDraws[22][i], 1);
		TextDrawSetSelectable(DLTextDraws[22][i], 0);

		DLTextDraws[23][i] = TextDrawCreate(190.000000, 319.000000, "Mo hop qua");
		TextDrawAlignment(DLTextDraws[23][i], 2);
		TextDrawBackgroundColor(DLTextDraws[23][i], 255);
		TextDrawFont(DLTextDraws[23][i], 3);
		TextDrawLetterSize(DLTextDraws[23][i], 0.300000, 1.399999);
		TextDrawColor(DLTextDraws[23][i], 13133000);
		TextDrawSetOutline(DLTextDraws[23][i], 0);
		TextDrawSetProportional(DLTextDraws[23][i], 1);
		TextDrawSetShadow(DLTextDraws[23][i], 1);
		TextDrawSetSelectable(DLTextDraws[23][i], 0);

		DLTextDraws[24][i] = TextDrawCreate(450.000000, 319.000000, "Mo hop qua");
		TextDrawAlignment(DLTextDraws[24][i], 2);
		TextDrawBackgroundColor(DLTextDraws[24][i], 255);
		TextDrawFont(DLTextDraws[24][i], 3);
		TextDrawLetterSize(DLTextDraws[24][i], 0.300000, 1.399999);
		TextDrawColor(DLTextDraws[24][i], 13133000);
		TextDrawSetOutline(DLTextDraws[24][i], 0);
		TextDrawSetProportional(DLTextDraws[24][i], 1);
		TextDrawSetShadow(DLTextDraws[24][i], 1);
		TextDrawSetSelectable(DLTextDraws[24][i], 0);
	}
...
{
    PlayernDPDz[playerid][0] = CreatePlayerTextDraw(playerid, 27.333332, 179.214828, "100");
	PlayerTextDrawLetterSize(playerid, PlayernDPDz[playerid][0], 0.400000, 1.600000);
	PlayerTextDrawAlignment(playerid, PlayernDPDz[playerid][0], 1);
	PlayerTextDrawColor(playerid, PlayernDPDz[playerid][0], -1);
	PlayerTextDrawSetShadow(playerid, PlayernDPDz[playerid][0], 0);
	PlayerTextDrawSetOutline(playerid, PlayernDPDz[playerid][0], 0);
	PlayerTextDrawBackgroundColor(playerid, PlayernDPDz[playerid][0], 255);
	PlayerTextDrawFont(playerid, PlayernDPDz[playerid][0], 2);
	PlayerTextDrawSetProportional(playerid, PlayernDPDz[playerid][0], 1);
	PlayerTextDrawSetShadow(playerid, PlayernDPDz[playerid][0], 0);

	PlayernDPDz[playerid][1] = CreatePlayerTextDraw(playerid, 25.666656, 208.251831, "100");
	PlayerTextDrawLetterSize(playerid, PlayernDPDz[playerid][1], 0.400000, 1.600000);
	PlayerTextDrawAlignment(playerid, PlayernDPDz[playerid][1], 1);
	PlayerTextDrawColor(playerid, PlayernDPDz[playerid][1], -1);
	PlayerTextDrawSetShadow(playerid, PlayernDPDz[playerid][1], 0);
	PlayerTextDrawSetOutline(playerid, PlayernDPDz[playerid][1], 0);
	PlayerTextDrawBackgroundColor(playerid, PlayernDPDz[playerid][1], 255);
	PlayerTextDrawFont(playerid, PlayernDPDz[playerid][1], 2);
	PlayerTextDrawSetProportional(playerid, PlayernDPDz[playerid][1], 1);
	PlayerTextDrawSetShadow(playerid, PlayernDPDz[playerid][1], 0);

    TextDraw_1_1[playerid][0] = CreatePlayerTextDraw(playerid, 4.666662, 429.348144, "ID:_99");
	PlayerTextDrawLetterSize(playerid, TextDraw_1_1[playerid][0], 0.161000, 1.214222);
	PlayerTextDrawAlignment(playerid, TextDraw_1_1[playerid][0], 1);
	PlayerTextDrawColor(playerid, TextDraw_1_1[playerid][0], -1);
	PlayerTextDrawSetShadow(playerid, TextDraw_1_1[playerid][0], 0);
	PlayerTextDrawSetOutline(playerid, TextDraw_1_1[playerid][0], 0);
	PlayerTextDrawBackgroundColor(playerid, TextDraw_1_1[playerid][0], 255);
	PlayerTextDrawFont(playerid, TextDraw_1_1[playerid][0], 2);
	PlayerTextDrawSetProportional(playerid, TextDraw_1_1[playerid][0], 1);
	PlayerTextDrawSetShadow(playerid, TextDraw_1_1[playerid][0], 0);

	TextDraw_1_1[playerid][1] = CreatePlayerTextDraw(playerid, 32.666656, 429.762939, "level:_99");
	PlayerTextDrawLetterSize(playerid, TextDraw_1_1[playerid][1], 0.145666, 1.039999);
	PlayerTextDrawAlignment(playerid, TextDraw_1_1[playerid][1], 1);
	PlayerTextDrawColor(playerid, TextDraw_1_1[playerid][1], -1);
	PlayerTextDrawSetShadow(playerid, TextDraw_1_1[playerid][1], 0);
	PlayerTextDrawSetOutline(playerid, TextDraw_1_1[playerid][1], 0);
	PlayerTextDrawBackgroundColor(playerid, TextDraw_1_1[playerid][1], 255);
	PlayerTextDrawFont(playerid, TextDraw_1_1[playerid][1], 2);
	PlayerTextDrawSetProportional(playerid, TextDraw_1_1[playerid][1], 1);
	PlayerTextDrawSetShadow(playerid, TextDraw_1_1[playerid][1], 0);
