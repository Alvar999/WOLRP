public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    ...
    if(dialogid == DIALOG_POTCRACK)
    {
        if(response)
		{
			if(listitem == 0) // POT
			{
			    if(dialogid == DIALOG_SELLPOT && response == 1)
				{
					if(strfind(inputtext, "%", true) != -1) {
						return ShowPlayerDialog(playerid, DIALOG_POTCRACK, DIALOG_STYLE_LIST, "{ffffff} WOLRP.NET | BAN POT / CRACK", "SELL POT\t1POT = 1,000$\nSELL CRACK\t1 CRACK = 1,000$", "Dong y", "Huy bo");
					}
					...
					new stringcc[1280];
					if(IsPlayerInRangeOfPoint(playerid, 3.0, -2455.0850,-133.2295,26.1553))
					{
					    if(PlayerInfo[playerid][pPot] > 0)
					    {
					        if(PlayerInfo[playerid][pPot] >= pot)
					        {
						        PlayerInfo[playerid][pPot] -= pot;
						        PlayerInfo[playerid][pCash] += pot * 1000;
						        format(stringcc, sizeof(stringcc), "Nguoi choi (( %s )) , vua ban thanh cong %d pot", GetPlayerNameEx(playerid), pot);
						        ...
						        return 1;
					        }else SendClientMessage(playerid, COLOR_GREEN, "Ban khong co nhieu pot den the.");
					    }else SendClientMessage(playerid, COLOR_GREEN, "Ban khong co Pot nao de ban'.");
					}
				}
			}
			if(listitem == 1) // CRACK
			{
			    if(dialogid == DIALOG_SELLCRACK && response == 1)
				{
					if(strfind(inputtext, "%", true) != -1) {
						return ShowPlayerDialog(playerid, DIALOG_POTCRACK, DIALOG_STYLE_LIST, "{ffffff} WOLRP.NET | BAN POT / CRACK", "SELL POT\t1POT = 1,000$\nSELL CRACK\t1 CRACK = 1,000$", "Dong y", "Huy bo");
					}
					...
					if(IsPlayerInRangeOfPoint(playerid, 3.0, -2455.0850,-133.2295,26.1553))
					{
					    if(PlayerInfo[playerid][pCrack] > 0)
					    {
					        if(PlayerInfo[playerid][pCrack] >= crack)
					        {
						        ...
						        PlayerInfo[playerid][pCash] += crack * 2000;
						        format(stringcc, sizeof(stringcc), "Nguoi choi (( %s )) , vua ban thanh cong %d Crack", GetPlayerNameEx(playerid), crack);
						        ProxDetectorWrap(playerid, stringcc, 92, 20.0, COLOR_PURPLE, COLOR_PURPLE, COLOR_PURPLE, COLOR_PURPLE, COLOR_PURPLE);
						        SendClientMessage(playerid, COLOR_GREEN, "Ban da mua thanh cong kimcuong.");
						        return 1;
					        }else SendClientMessage(playerid, COLOR_GREEN, "Ban khong co nhieu crack den the.");
					    }else SendClientMessage(playerid, COLOR_GREEN, "Ban khong co Crack nao de ban'.");
					}
				}
			}
		}
    ...
    if(dialogid == CONGVIEC_1)
	{
		if(response)
		{
			if(PlayerInfo[playerid][pJob] == 0 || PlayerInfo[playerid][pJob] == 0)
			{
			    PlayerInfo[playerid][pJob] = 21;
			    SendClientMessageEx(playerid, COLOR_LIGHTGREEN, "Ban da nhan duoc cong viec (( Pizza Boy )).");
			    SendClientMessageEx(playerid, COLOR_WHITE, "Ban duoc thay trang phuc Pizza Boy!");
				PlayerInfo[playerid][pModel] = 155;
				SetPlayerSkin(playerid, 155);
			    return 1;
			}else SendClientMessageEx(playerid, -1, "Ban hien tai dang nhan mot cong viec nao do, vui long (( /quitjob )) de nhan cong viec nay.");
		}
	}

	if(dialogid == CONGVIEC_2)
	{
		if(response)
		{
			if(PlayerInfo[playerid][pJob] == 0 || PlayerInfo[playerid][pJob] == 0)
			{
			    ...
			    SendClientMessageEx(playerid, COLOR_LIGHTGREEN, "Ban da nhan duoc cong viec (( Trucker )).");
			    SendClientMessageEx(playerid, COLOR_WHITE, "Ban duoc thay trang phuc Trucker !");
	...
	if(dialogid == CONGVIEC_3)
	{
		if(response)
		{
			if(PlayerInfo[playerid][pJob] == 0 || PlayerInfo[playerid][pJob] == 0)
			{
			    ...
			    SendClientMessageEx(playerid, COLOR_LIGHTGREEN, "Ban da nhan duoc cong viec (( Nguoi Van Chuyen Xang / Dau )).");
			    return 1;
			}else SendClientMessageEx(playerid, -1, "Ban hien tai dang nhan mot cong viec nao do, vui long (( /quitjob )) de nhan cong viec nay.");
		}
	}

	if(dialogid == CONGVIEC_4)
	{
		if(response)
		{
			if(PlayerInfo[playerid][pJob] == 0 || PlayerInfo[playerid][pJob] == 0)
			{
			    ...
			    SendClientMessageEx(playerid, COLOR_LIGHTGREEN, "Ban da nhan duoc cong viec (( Quan Ly Moi Truong )).");
			    SendClientMessageEx(playerid, COLOR_WHITE, "Ban duoc thay trang phuc nguoi Quan Ly Moi Truong");
			    PlayerInfo[playerid][pModel] = 27;
	...
	if(dialogid == CONGVIEC_5)
	{
		if(response)
		{
			if(PlayerInfo[playerid][pJob] == 0 || PlayerInfo[playerid][pJob] == 0)
			{
			    ...
			    SendClientMessageEx(playerid, COLOR_LIGHTGREEN, "Ban da nhan duoc cong viec (( Tho Moc )).");
			    SendClientMessageEx(playerid, COLOR_WHITE, "Ban duoc thay trang phuc nguoi Quan Ly Moi Truong");
	...
	if(dialogid == CONGVIEC_6)
	{
		if(response)
		{
			if(PlayerInfo[playerid][pJob] == 0 || PlayerInfo[playerid][pJob] == 0)
			{
			    PlayerInfo[playerid][pJob] = 302;
			    SendClientMessageEx(playerid, COLOR_LIGHTGREEN, "Ban da nhan duoc cong viec (( Tho Mo | Dao Khoang San )).");
			    return 1;
			}else SendClientMessageEx(playerid, -1, "Ban hien tai dang nhan mot cong viec nao do, vui long (( /quitjob )) de nhan cong viec nay.");
		}
	}

	if(dialogid == CONGVIEC_7)
	{
		if(response)
		{
			if(PlayerInfo[playerid][pJob] == 0 || PlayerInfo[playerid][pJob] == 0)
			{
			    PlayerInfo[playerid][pJob] = 26;
			    SendClientMessageEx(playerid, COLOR_LIGHTGREEN, "Ban da nhan duoc cong viec (( Giao Trai Cay )).");
			    return 1;
			}else SendClientMessageEx(playerid, -1, "Ban hien tai dang nhan mot cong viec nao do, vui long (( /quitjob )) de nhan cong viec nay.");
		}
	}

	if(dialogid == CONGVIEC_8)
	{
		if(response)
		{
			if(PlayerInfo[playerid][pJob] == 0 || PlayerInfo[playerid][pJob] == 0)
			{
			    ...
			    SendClientMessageEx(playerid, COLOR_LIGHTGREEN, "Ban da nhan duoc cong viec (( Nong Dan )).");
			    SendClientMessageEx(playerid, COLOR_WHITE, "Ban duoc thay trang phuc nguoi Nong Dan");
	...
	if(dialogid == CONGVIEC_9)
	{
		if(response)
		{
			if(PlayerInfo[playerid][pJob] == 0 || PlayerInfo[playerid][pJob] == 0)
			{
			    ...
			    SendClientMessageEx(playerid, COLOR_LIGHTGREEN, "Ban da nhan duoc cong viec (( Sua Chua Dau Khi )).");
			    SendClientMessageEx(playerid, COLOR_WHITE, "Ban duoc thay trang phuc nguoi Nong Dan");
			    PlayerInfo[playerid][pModel] = 34;
				SetPlayerSkin(playerid, 34);
			    return 1;
	...
	if(dialogid == CONGVIEC_10)
	{
		if(response)
		{
			if(PlayerInfo[playerid][pJob] == 0 || PlayerInfo[playerid][pJob] == 0)
			{
			    ...
			    SendClientMessageEx(playerid, COLOR_LIGHTGREEN, "Ban da nhan duoc cong viec (( Giao Banh Mi )).");
			    return 1;
			}else SendClientMessageEx(playerid, -1, "Ban hien tai dang nhan mot cong viec nao do, vui long (( /quitjob )) de nhan cong viec nay.");
		}
	}

	if(dialogid == CONGVIEC_11)
	{
		if(response)
		{
			if(PlayerInfo[playerid][pJob] == 0 || PlayerInfo[playerid][pJob] == 0)
			{
			    ...
			    SendClientMessageEx(playerid, COLOR_LIGHTGREEN, "Ban da nhan duoc cong viec (( San Xuat Thit )).");
			    return 1;
			}else SendClientMessageEx(playerid, -1, "Ban hien tai dang nhan mot cong viec nao do, vui long (( /quitjob )) de nhan cong viec nay.");
		}
	}
	
	if(dialogid == CONGVIEC_12)
	{
		if(response)
		{
			if(PlayerInfo[playerid][pJob] == 0 || PlayerInfo[playerid][pJob] == 0)
			{
			    ...
			    SendClientMessageEx(playerid, COLOR_LIGHTGREEN, "Ban da nhan duoc cong viec (( Dao Da )).");
			    return 1;
			}else SendClientMessageEx(playerid, -1, "Ban hien tai dang nhan mot cong viec nao do, vui long (( /quitjob )) de nhan cong viec nay.");
		}
	}
	...
	if(dialogid == DIALOG_ROBBANK)
	{
		...
		{
		    if(strfind(inputtext, "%", true) != -1) {
			return ShowPlayerDialog(playerid, DIALOG_ROBBANK, DIALOG_STYLE_INPUT, "CUOP NGAN HANG", "Ban vui long dien mat khau cua sat o ben duoi :\nNeu nhap sai qua 3 lan se +5 Wanted - Canh sat se phat hien.", "Dong y", "Huy bo");
			}
			if(strfind(inputtext, "c", true) != -1) {
				return ShowPlayerDialog(playerid, DIALOG_ROBBANK, DIALOG_STYLE_INPUT, "CUOP NGAN HANG", "Ban vui long dien mat khau cua sat o ben duoi :\nNeu nhap sai qua 3 lan se +5 Wanted - Canh sat se phat hien.", "Dong y", "Huy bo");
			}
			new matkhaubank = strval(inputtext);
			if(matkhaubank == masocua)
			{
			    DestroyDynamicObject(khoasat1);
				new str[128];
			...
			else if(matkhaubank > masocua)
			{
				GameTextForPlayer(playerid, "~R~Ma so' be' hon", 3000, 3);
				SoLanNhapBank[playerid] += 1;
			}
			else if(matkhaubank < masocua)
			{
    ...
    if(dialogid == MUAVKHI)
    {
        if(response)
		{
			...
			{
				if(PlayerInfo[playerid][pCash] >= BaseBall_Bat_)
				{
     				if(PlayerWP[BaseBall_Bat] < 0) //
     				{
     				    PlayerInfo[playerid][pCash] -= BaseBall_Bat_;
     				    format(string, sizeof(string), "Ban da mua thanh cong {00ff00}BaseBall Bat{ffffff} voi gia %d, tai cho den.", BaseBall_Bat_);
     				    SendClientMessageEx(playerid, COLOR_GREEN, string);
     				    GivePlayerValidWeapon(playerid, 5, 60000);
						//_______---
     				}else SendClientMessageEx(playerid, COLOR_LIGHTGREEN, "Vu khi nay , hien dang het hang vui long quay lai sau.");
				}else SendClientMessageEx(playerid, COLOR_LIGHTGREEN, "Ban khong du $ de mua vu khi , tai cho den.");
			}
			if(listitem == 1) // Shovel
			{
				if(PlayerInfo[playerid][pCash] >= Shovel_)
				{
     				if(PlayerWP[Shovel] < 0) //
     				{
     				    PlayerInfo[playerid][pCash] -= Shovel_;
     				    format(string, sizeof(string), "Ban da mua thanh cong {00ff00}Shovel{ffffff} voi gia %d, tai cho den.", Shovel_);
     				    SendClientMessageEx(playerid, COLOR_GREEN, string);
			...
			if(listitem == 2) // Pool cue
			{
				if(PlayerInfo[playerid][pCash] >= Pool_cue_)
				{
     				if(PlayerWP[Pool_cue] < 0) //
     				{
     				    PlayerInfo[playerid][pCash] -= Pool_cue_;
     				    format(string, sizeof(string), "Ban da mua thanh cong {00ff00}Pool Cue{ffffff} voi gia %d, tai cho den.", Pool_cue_);
     				    SendClientMessageEx(playerid, COLOR_GREEN, string);
			...
			if(listitem == 3) // Kantana
			{
				if(PlayerInfo[playerid][pCash] >= Kantana_)
				{
     				if(PlayerWP[Kantana] < 0)
     				{
     				    PlayerInfo[playerid][pCash] -= Kantana_;
     				    format(string, sizeof(string), "Ban da mua thanh cong {00ff00}Kantana{ffffff} voi gia %d, tai cho den.", Kantana_);
     				    SendClientMessageEx(playerid, COLOR_GREEN, string);
			...
			if(listitem == 4) // Flowers
			{
				if(PlayerInfo[playerid][pCash] >= Flowers_)
				{
     				if(PlayerWP[Flowers] < 0)
     				{
     				    PlayerInfo[playerid][pCash] -= Flowers_;
     				    format(string, sizeof(string), "Ban da mua thanh cong {00ff00}Flowers{ffffff} voi gia %d, tai cho den.", Flowers_);
     				    SendClientMessageEx(playerid, COLOR_GREEN, string);
			...
			if(listitem == 5) // Cane
			{
				if(PlayerInfo[playerid][pCash] >= Cane_)
				{
     				if(PlayerWP[Cane] < 0)
     				{
     				    PlayerInfo[playerid][pCash] -= Cane_;
     				    format(string, sizeof(string), "Ban da mua thanh cong {00ff00}Flowers{ffffff} voi gia %d, tai cho den.", Cane_);
     				    SendClientMessageEx(playerid, COLOR_GREEN, string);
			...
			if(listitem == 6) // 9mm
			{
				if(PlayerInfo[playerid][pCash] >= mm9_)
				{
     				if(PlayerWP[mm9cc] < 0)
     				{
     				    PlayerInfo[playerid][pCash] -= mm9_;
     				    format(string, sizeof(string), "Ban da mua thanh cong {00ff00}9mm{ffffff} voi gia %d, tai cho den.", mm9_);
     				    SendClientMessageEx(playerid, COLOR_GREEN, string);
			...
			if(listitem == 7) // Silenced pistol
			{
				if(PlayerInfo[playerid][pCash] >= Silenced_pistol_)
				{
     				if(PlayerWP[Silenced_pistol] < 0)
     				{
     				    PlayerInfo[playerid][pCash] -= Silenced_pistol_;
     				    format(string, sizeof(string), "Ban da mua thanh cong {00ff00}Silenced Pistol{ffffff} voi gia %d, tai cho den.", Silenced_pistol_);
     				    SendClientMessageEx(playerid, COLOR_GREEN, string);
			...
			if(listitem == 8) // Deagle
			{
				if(PlayerInfo[playerid][pCash] >= Deagle_)
				{
     				if(PlayerWP[DE] != 10)
     				{
     				    PlayerInfo[playerid][pCash] -= Deagle_;
     				    format(string, sizeof(string), "Ban da mua thanh cong {00ff00}Desert Eagle{ffffff} voi gia %d, tai cho den.", Deagle_);
     				    SendClientMessageEx(playerid, COLOR_GREEN, string);
			...
			{
				if(PlayerInfo[playerid][pCash] >= Shotgun_)
				{
     				if(PlayerWP[Shotgun] < 0)
     				{
     				    PlayerInfo[playerid][pCash] -= Shotgun_;
     				    format(string, sizeof(string), "Ban da mua thanh cong {00ff00}Shotgun{ffffff} voi gia %d, tai cho den.", Shotgun_);
     				    SendClientMessageEx(playerid, COLOR_GREEN, string);
			...
			if(listitem == 10) // Tec9
			{
				if(PlayerInfo[playerid][pCash] >= Tec_9_)
				{
     				if(PlayerWP[Tec_9] !=10)
     				{
     				    PlayerInfo[playerid][pCash] -= Tec_9_;
     				    format(string, sizeof(string), "Ban da mua thanh cong {00ff00}Tec9{ffffff} voi gia %d, tai cho den.", Tec_9_);
     				    SendClientMessageEx(playerid, COLOR_GREEN, string);
			...
			if(listitem == 11) // Micro Uzi
			{
				if(PlayerInfo[playerid][pCash] >= Micro_Uzi_)
				{
     				if(PlayerWP[Micro_Uzi] < 0)
     				{
     				    PlayerInfo[playerid][pCash] -= Micro_Uzi_;
     				    format(string, sizeof(string), "Ban da mua thanh cong {00ff00}Micro Uzi{ffffff} voi gia %d, tai cho den.", Micro_Uzi_);
     				    SendClientMessageEx(playerid, COLOR_GREEN, string);
			...
			if(listitem == 12) // MP5
			{
				if(PlayerInfo[playerid][pCash] >= MP5_)
				{
     				if(PlayerWP[MP5] < 0)
     				{
     				    PlayerInfo[playerid][pCash] -= MP5_;
     				    format(string, sizeof(string), "Ban da mua thanh cong {00ff00}MP5{ffffff} voi gia %d, tai cho den.", MP5_);
     				    SendClientMessageEx(playerid, COLOR_GREEN, string);
			...
			if(listitem == 13) // Country Rifle
			{
				if(PlayerInfo[playerid][pCash] >= Country_rifle_)
				{
     				if(PlayerWP[Country_rifle] != 5)
     				{
     				    PlayerInfo[playerid][pCash] -= Country_rifle_;
     				    format(string, sizeof(string), "Ban da mua thanh cong {00ff00}Country Rifle{ffffff} voi gia %d, tai cho den.", Country_rifle_);
     				    SendClientMessageEx(playerid, COLOR_GREEN, string);
     				    GivePlayerValidWeapon(playerid, 33, 60000);
     				    PlayerWP[Country_rifle] += 1;
						//_______---
     				}else SendClientMessageEx(playerid, COLOR_LIGHTGREEN, "Vu khi nay , hien dang het hang vui long quay lai sau.");
				}else SendClientMessageEx(playerid, COLOR_LIGHTGREEN, "Ban khong du $ de mua vu khi , tai cho den.");
			}
			/*if(listitem == 14) // AK47
			{
				if(PlayerInfo[playerid][pCash] >= AK47_)
				{
     				if(PlayerWP[AK47] < 0)
     				{
     				    PlayerInfo[playerid][pCash] -= AK47_;
     				    format(string, sizeof(string), "Ban da mua thanh cong {00ff00}AK-47{ffffff} voi gia %d, tai cho den.", AK47_);
     				    SendClientMessageEx(playerid, COLOR_GREEN, string);
			...
			if(listitem == 15) // M4a1
			{
				if(PlayerInfo[playerid][pCash] >= M4a1_)
				{
     				if(PlayerWP[M4] < 0)
     				{
     				    PlayerInfo[playerid][pCash] -= M4a1_;
     				    format(string, sizeof(string), "Ban da mua thanh cong {00ff00}M4a1{ffffff} voi gia %d, tai cho den.", M4a1_);
     				    SendClientMessageEx(playerid, COLOR_GREEN, string);
			...
			if(listitem == 16) // Spas12
			{
				if(PlayerInfo[playerid][pCash] >= Spas12_)
				{
     				if(PlayerWP[Spas12] < 0)
     				{
     				    PlayerInfo[playerid][pCash] -= Spas12_;
     				    format(string, sizeof(string), "Ban da mua thanh cong {00ff00}Spas12{ffffff} voi gia %d, tai cho den.", Spas12_);
     				    SendClientMessageEx(playerid, COLOR_GREEN, string);
			...
			if(listitem == 17) // Sniper
			{
				if(PlayerInfo[playerid][pCash] >= Sniper_)
				{
     				if(PlayerWP[Sniper] != 3)
     				{
     				    PlayerInfo[playerid][pCash] -= Sniper_;
     				    format(string, sizeof(string), "Ban da mua thanh cong {00ff00}Spas12{ffffff} voi gia %d, tai cho den.", Sniper_);
     				    SendClientMessageEx(playerid, COLOR_GREEN, string);
			...
			if(listitem == 19) // Administrator
			{
				SendClientMessageEx(playerid, COLOR_YELLOW, "Hien tai lenh nay dang duoc update by nDP.");
			}*/
		}
    }

    if(dialogid == DIALOG_GIAOBAO)
    {
        if(response)
        {
            if(listitem == 0) // HUONG DAN
		    {
		    	new str[2460], str1[1280], str2[1280], str3[1280], str4[1280], str5[1280], str6[1280], name[1280];
				format(str1, sizeof(str), "{b32d00}CONG VIEC GIAO BAO - HUONG DAN{FFFFFF}");
			    format(str2, sizeof(str), "   + Ban can nhan cong viec {00ff00}GIAO BAO{ffffff}");
			    format(str3, sizeof(str), "   + Sau khi nhan cong viec {00ff00}GIAO BAO{ffffff} , ban vui long nhan {ff1a8c}LAY GIAY BAO{FFFFFF}");
			    format(str4, sizeof(str), "   + Mot to bao co gia : {ff0000}%d{ffffff}", PlayerGB[playerid][pToBao]);
			    format(str5, sizeof(str), "Neu da hieu , ban vui long nhan ' OK '.");
			    format(str6, sizeof(str), "");
			    format(str, sizeof(str), "%s\n\n%s\n\n%s\n\n%s\n\n%s\n\n%s", str1,str2,str3,str4,str5,str6);
			    format(name, sizeof(name), "GIAO BAO");
				ShowPlayerDialog(playerid, DIALOG_NOTHING, DIALOG_STYLE_MSGBOX, name, str, "Ok", "");
			}
			if(listitem == 1) // XIN VIEC
		    {
     			SendClientMessageEx(playerid, COLOR_GRAD2, "Ban da xin viec giao bao thanh cong.");
			}
			if(listitem == 2) // LAY GIAY BAO
		    {
		        if(PlayerInfo[playerid][pJob] == 25 || PlayerInfo[playerid][pJob2] == 25)
		        {
		            if(PlayerGB[playerid][pSoLuongBao] <= 100)
		            {
		                new str[2460], str1[1280], str2[1280], str3[1280], str4[1280], str5[1280], name[1280];
						format(str1, sizeof(str), "{b32d00}CONG VIEC GIAO BAO - HUONG DAN{FFFFFF}");
					    format(str2, sizeof(str), "   + SO BAO CON LAI : %d", (100 - PlayerGB[playerid][pSoLuongBao]));
					    format(str3, sizeof(str), "   + Mot to bao co gia : %d", PlayerGB[playerid][pToBao]);
					    format(str4, sizeof(str), "   + Ban muon mua bao nhieu to bao");
					    format(str5, sizeof(str), "BAN VUI LONG NHAP SO LUONG BAO MA BAN MUON MUA.");
					    format(str, sizeof(str), "%s\n\n%s\n\n%s\n\n%s\n\n%s", str1,str2,str3,str4,str5);
					    format(name, sizeof(name), "GIAO BAO");
						ShowPlayerDialog(playerid, DIALOG_MUABAO, DIALOG_STYLE_INPUT, name, str, "Dong Y", "Huy Bo");
					}else SendClientMessageEx(playerid, COLOR_GRAD2, "Hien tai so luong bao da het , vui long quay lai sau.");
				}else SendClientMessageEx(playerid, COLOR_GRAD2, "Ban chua nhan cong viec giao bao.");
			}
        }
    }
    if(dialogid == DIALOG_MUABAO)
	{
	  	if(response)
		{
		    if(strfind(inputtext, "%", true) != -1) {
			return ShowPlayerDialog(playerid, DIALOG_MUABAO, DIALOG_STYLE_INPUT, "GIAO BAO","BAN VUI LONG NHAP SO LUONG BAO MA BAN MUON MUA.","Dong y","Huy");
			}
			if(strfind(inputtext, "c", true) != -1) {
				return ShowPlayerDialog(playerid, DIALOG_MUABAO, DIALOG_STYLE_INPUT, "GIAO BAO","BAN VUI LONG NHAP SO LUONG BAO MA BAN MUON MUA.","Dong y","Huy");
			}
		    if(PlayerGB[playerid][pDaMuaGB]  <= 5)
		    {
			    new muabao = strval(inputtext);
				//if(GetPlayerMoney(playerid) > muabao*PlayerGB[playerid][pToBao]) return SendClientMessageEx(playerid,COLOR_RED,"Ban khong co nhieu tien nhu the.");
				if(PlayerInfo[playerid][pCash] >= muabao*PlayerGB[playerid][pToBao])
				{
					PlayerGB[playerid][pDaMuaGB] += muabao;
					PlayerInfo[playerid][pCash] -= muabao*PlayerGB[playerid][pToBao];
					//new string[1280];
					format(string, sizeof(string), "Ban da mua thanh cong %s to bao voi gia %s", number_format(muabao), number_format(muabao*PlayerGB[playerid][pToBao]));
					SendClientMessageEx(playerid, COLOR_YELLOW, string);
					SendClientMessageEx(playerid, COLOR_GRAD2, "Su dung: /baocuatoi , de xem minh co bao nhieu to bao.");
					SendClientMessageEx(playerid, COLOR_GRAD2, "Su dung: /giaobao , de bat dau di giao bao cua minh.");
					PlayerGB[playerid][pSoLuongBao] += muabao;
				}else SendClientMessageEx(playerid,COLOR_RED,"Ban khong co nhieu tien nhu the.");
			}else SendClientMessageEx(playerid,COLOR_RED,"Ban khong the mua nhieu hon 5 to bao.");
		}
	}

    if(dialogid == NGUDAN) // xin viec
    {
        if(response)
        {
            if(listitem == 0) //Xin viec
		    {
		    	if(PlayerInfo[playerid][pJob] == 0)
            	{
                	...
                	SendClientMessageEx(playerid, COLOR_YELLOW, "* Ban da xin viec Ngu Dan thanh cong [ID Job : 15]");
                }
                else return SendClientMessageEx(playerid, COLOR_RED, "* Ban khong the nhan cong viec nay tiep tuc, vui long /quitjob 1 or /quitjob 2.");
			}
			if(listitem == 1) // Xem huong dan
		    {
                new str[2460], str1[1280], str2[1280], str3[1280], str4[1280], str5[1280], str6[1280], name[1280];
				format(str1, sizeof(str), "HUONG DAN LAM CONG VIEC NGU DAN", GetPlayerNameEx(playerid));
			    format(str2, sizeof(str), "   + Dau tien , ban can phai thue mot con tau! hoac lay nhung con tau co san.");
			    format(str3, sizeof(str), "   + Su dung , /timnoidanhca");
			    format(str4, sizeof(str), "   + Lai con tau den noi da duoc danh dau , /danhca");
			    format(str5, sizeof(str), "Sau khi da danh ca xong, ban quay ve noi tra thuyen!.");
			    format(str6, sizeof(str), "Ban co the ban' ca lai cho NPC Ngu Dan de nhan tien.");
			    format(str, sizeof(str), "%s\n\n%s\n\n%s\n\n%s\n\n%s\n\n%s", str1,str2,str3,str4,str5,str6);
			    format(name, sizeof(name), "CONG VIEC NGU DAN");
				ShowPlayerDialog(playerid, DIALOG_NOTHING, DIALOG_STYLE_MSGBOX, name, str, "Ok", "");
			}
			if(listitem == 2) // Thue Thuyen
		    {
                // THUE THUYEN
                new str[2460], str1[1280], str2[1280], str3[1280], str4[1280], name[1280];
				format(str1, sizeof(str), "THUE THUYEN", GetPlayerNameEx(playerid));
			    format(str2, sizeof(str), "   + GIA : 10,000$.");
			    format(str3, sizeof(str), "   + THUYEN : Speeder ");
			    format(str4, sizeof(str), "Neu ban muon thue chiec thuyen nay, vui long nhan dong y");
			    format(str, sizeof(str), "%s\n\n%s\n\n%s\n\n%s", str1,str2,str3,str4);
			    format(name, sizeof(name), "CONG VIEC NGU DAN");
				ShowPlayerDialog(playerid, DIALOG_THUETHUYEN, DIALOG_STYLE_MSGBOX, name, str, "Dong y", "Huy bo");

				//SendClientMessageEx(playerid, COLOR_RED, "Hien tai chuc nang thue thuyen nay dang cap nhat.");
			}
			if(listitem == 3)
			{
			    // BAN CA
			    new str[2460], str1[1280], str2[1280], str3[1280], str4[1280], name[1280];
				format(str1, sizeof(str), "NGU DAN : ", GetPlayerNameEx(playerid));
			    format(str2, sizeof(str), "   > BAN CA NHO.");
			    format(str3, sizeof(str), "   > BAN CA LON ");
			    format(str4, sizeof(str), "Ban muon ban ca loai nao ? ");
			    format(str, sizeof(str), "%s\n\n%s\n\n%s\n\n%s", str1,str2,str3,str4);
			    format(name, sizeof(name), "CONG VIEC NGU DAN");
				ShowPlayerDialog(playerid, LISTSELLCA, DIALOG_STYLE_LIST, name, str, "Ok", "");
			}
        }
    }
    
	if(dialogid == MENUDIENTHOAI)
	{
		if(listitem == 0)
	    {
			return cmd_goi(playerid, "");
	    }
	    if(listitem == 1)
	    {
		    return cmd_goi(playerid, "911");
	    }
	}
	...
	if(dialogid == MENUXE)
	{
	    ...
	    if(listitem == 1)
	    {
		    return cmd_chinhxe(playerid, "");
	    }
	    if(listitem == 2)
	    {
		    return cmd_car(playerid, "Hood");
	    }
	    if(listitem == 3)
	    {
     		return cmd_car(playerid, "Trunk");
	    }
	    if(listitem == 4)
	    {
     		return cmd_pvlock(playerid, "");
	    }
	    if(listitem == 5)
	    {
            return cmd_doxang(playerid, "");
		}
   }

	if(dialogid == MENUDICHVU)
	{
	    if(listitem == 0)
	    {
		    return cmd_dichvu(playerid, "taxi");
	    }
	    if(listitem == 1)
	    {
     		return cmd_dichvu(playerid, "suaxe");
	    }
	    if(listitem == 2)
	    {
     		return cmd_dichvu(playerid, "capcuu");
		}
   }

	if(dialogid == MENUPHAMPHAP)
	{
	    if(listitem == 0)
	    {
        ...
        if (response)
        {
            if(PlayerInfo[playerid][pCash] >= 10000)
            {
                if(PlayerInfo[playerid][pJob] == 24)
				{
					...
					CreateVehicle(453, NguDan_[rand][0], NguDan_[rand][1], NguDan_[rand][2], 0, random(255), random(255), -1);
					SetPlayerPos(playerid, NguDan_[rand][0], NguDan_[rand][1], NguDan_[rand][2]);
					VehicleFuel[playerid] = 100.0;
					...
					switch(randomselect)
					{
						case 0:
						{
							SetPlayerCheckpoint(playerid,-1265.4081,1496.7864,-0.5313, 2);
							SetPlayerMapIcon(playerid, 58, -1265.4081,1496.7864,-0.5313, 52, 0, MAPICON_LOCAL);
						}
						case 1:
						{
							SetPlayerCheckpoint(playerid,-1617.1155,1593.4934,-0.5204, 2);
							SetPlayerMapIcon(playerid, 59, -1617.1155,1593.4934,-0.5204, 52, 0, MAPICON_LOCAL);
						}
						case 2:
						{
							SetPlayerCheckpoint(playerid,-1933.5613,1675.7849,-0.5924, 2);
							SetPlayerMapIcon(playerid, 60, -1933.5613,1675.7849,-0.5924, 52, 0, MAPICON_LOCAL);
						}
					}
					SendClientMessage(playerid, -1, "Ban nen chay toi dia diem danh dau tren ban do, va su dung : /danhca.");
					CP[playerid] = 252000;

				}else SendClientMessageEx(playerid, COLOR_GREY, "Ban chua nhan cong viec ngu dan.");
            }else SendClientMessageEx(playerid, COLOR_GREY, "Ban khong co du tien de thue mot chiec thuyen danh ca.");
        }
    }
    if(dialogid == LISTSELLCA)
    {
        if(response)
	    {
	        if(listitem == 0)
	        ...
	        if(listitem == 1) // Ca Nho
	        {
	            ShowPlayerDialog(playerid, DIALOG_CANHO, DIALOG_STYLE_INPUT, "Ban ca", "1 Con Ca Nho = 1,500$", "Doi","Dong");
	        }
	        if(listitem == 2) // Ca Lon
	        {
	            ShowPlayerDialog(playerid, DIALOG_CALON, DIALOG_STYLE_INPUT, "Ban ca", "1 Con Ca Lon = 3,000$", "Doi","Dong");
	        }
	        if(listitem == 3)
	        {
	        }
    ...
    if(dialogid == DIALOG_CANHO)
	{
		if(response)
		{
			if(PlayerInfo[playerid][pCaNho] < strval(inputtext)) return SendClientMessageEx(playerid,COLOR_RED,"Ban khong co nhieu ca nho nhu the!");
			PlayerInfo[playerid][pCaNho] -= strval(inputtext);
			PlayerInfo[playerid][pCash] += strval(inputtext)*1500;
			SendClientMessage(playerid, -1, "{FF0000}[!] {FFFFFF}Ban da ban ca thanh cong.");
		}
	}
	if(dialogid == DIALOG_CALON)
	{
		if(response)
		{
			if(PlayerInfo[playerid][pCaLon] < strval(inputtext)) return SendClientMessageEx(playerid,COLOR_RED,"Ban khong co nhieu ca lon nhu the!");
			PlayerInfo[playerid][pCaLon] -= strval(inputtext);
			PlayerInfo[playerid][pCash] += strval(inputtext)*3000;
			SendClientMessage(playerid, -1, "{FF0000}[!] {FFFFFF}Ban da ban ca thanh cong.");
		}
	}
    ...
    if(dialogid == DIALOG_BANK)
    {
		if(response)
	    {
	        ...
	        if(listitem == 4)
	        {
			    ...
			    format(str2, sizeof(str), "   + SO TAI KHOAN NGAN HANG : %d", PlayerInfo[playerid][pTKNganHang]);
			...
			if(listitem == 6)
			{
			    ...
			    format(str, sizeof(str), "%s\n\n%s\n\n%s\n\n%s\n\n%s", str1,str2,str3,str4,str5);
			    format(name, sizeof(name), "BANK");
				ShowPlayerDialog(playerid, DIALOG_CHUYENTIEN, DIALOG_STYLE_INPUT, name, str, "Ok", "");
			}
		}
	}
	
	if(dialogid == MENUBANG)
	{
		if(listitem == 0)
	    {
			return cmd_newb(playerid, "");
	    }
	    if(listitem == 1)
	    {
		    return cmd_thongtin(playerid, "");
	    }
	    if(listitem == 2)
	    {
     		return cmd_tuido(playerid, "");
	    }
	    if(listitem == 3)
	    {
     		return ShowPlayerDialog(playerid, MENUXE, DIALOG_STYLE_LIST, "Menu Xe","{5ff600}Khoi Dong {00f0f6}Xe\n{5ff600}Kho {00f0f6}Xe\n{5ff600}Mui {00f0f6}Xe\n{5ff600}Cop {00f0f6}Xe\n{5ff600}khoa {00f0f6}Xe\n{5ff600}Do Xang", "Chon", "Thoat");
	    }
	    if(listitem == 4)
	    {
            return cmd_muacapdo(playerid, "");
		}
	    if(listitem == 5)
	    {
			return ShowPlayerDialog(playerid, MENUDICHVU, DIALOG_STYLE_LIST, "Menu Dich Vu","{5ff600}Dich Vu {fbfd00}Taxi\n{5ff600}Dich Vu {00f0f6}Sua Xe\n{5ff600}Dich Vu {f66300}Cap Cuu", "Chon", "Thoat");
	    }
	    if(listitem == 6)
	    {
			return cmd_timvieclam(playerid, "");
	    }
	    if(listitem == 7)
	    {
	    ...
	    if(listitem == 8)
	    {
			return ShowPlayerDialog(playerid, MENUPHAMPHAP, DIALOG_STYLE_LIST, "Menu Pham Phap","{5ff600}Su Dung {00f0f6}Pot\n{5ff600}Su Dung {00f0f6}Crack", "Chon", "Thoat");
	    }
	    if(listitem == 9)
	    {
			return cmd_baocao(playerid, "");
	    }
	    if(listitem == 10)
	    {
	...
	if(dialogid == DIALOG_CHUYENTIEN)
	{
		if(response)
        {
            ...
            ShowPlayerDialog(playerid, DIALOG_CHUYENTIEN2, DIALOG_STYLE_INPUT, "Chuyen khoan", "Nhap so tien ban muon chuyen", "Dong y", "Huy bo");
        }
	}
	if(dialogid == DIALOG_CHUYENTIEN2)
    {
        if(response)
        {
            ...
            }else SendClientMessageEx(playerid, COLOR_YELLOW, "Ban khong co nhieu tien nhu the , vui long xem lai.");
        }
    }
    ...
    if(dialogid == AUDIO_URL_BOOM)
	{
	    if(response)
	    {
	        ...
	        if(listitem == 1)
	        {
		 	 	ShowPlayerDialog(playerid, AUDIO_URL_LIST, DIALOG_STYLE_LIST, "Lua chon Playlist", "The Luong - Phuc Chinh\nNhac Tre Remix 2021 Hay Nhat Hien Nay\nTop 10 Ban Nhac EDM Cua Cau Vang\nNONSTOP VINAHOUSE 2021 - Chuyen Bay Khong Tram Dat\nPhao - 2 Phut", "OK", "Tu choi");
		    }
		    if(listitem == 2)
		    {
    ...
    if(dialogid == AUDIO_URL_BOOM)
	{
	    if(response)
	    {
	        if(listitem == 0)
	        {
                ShowPlayerDialog(playerid, AUDIO_URL_URL, DIALOG_STYLE_INPUT, "Duong dan bai hat", "Hay go vao duong dan bai hat", "OK", "Tu choi");
		    }
	        if(listitem == 1)
	        {
		 	 	ShowPlayerDialog(playerid, AUDIO_URL_LIST, DIALOG_STYLE_LIST, "Lua chon Playlist", "Nhac POP", "OK", "Tu choi");
		    }
	    }
	}

	if(dialogid == AUDIO_URL_URL)
	{
	    if(response)
	    {
		 	SendAudioURLToRange(inputtext,GetPVarFloat(playerid, "pBoomBoxX"),GetPVarFloat(playerid, "pBoomBoxY"),GetPVarFloat(playerid, "pBoomBoxZ"),50);
		    format(string,sizeof(string),"Ban da dat duong dan music %s ",inputtext);
	        SendClientMessage(playerid, COLOR_YELLOW, string);
	    }
	}
	if(dialogid == AUDIO_URL_LIST)
	{
	    if(listitem == 0)
	    {
		 	// 181 Power
		 	SendAudioURLToRange("http://listen.181fm.com/181-power_128k.mp3?esPlayer&cb=855456.mp3",GetPVarFloat(playerid, "pBoomBoxX"),GetPVarFloat(playerid, "pBoomBoxY"),GetPVarFloat(playerid, "pBoomBoxZ"),50);
	        SendClientMessage(playerid, COLOR_YELLOW, "Ban da chon kenh nhac Pop - Power 181");
	    }
	    if(listitem == 2)
	    {
		 	//Bai hat 2
		 	SendAudioURLToRange("http://stream2.s2.mp3.zdn.vn/fsfsdfdsfdserwrwq3/36fe4a08bab41ace7b457a9c01da4c3f/519aa68d/2011/11/24/0/4/041b9e4a328991a5a33698e2d083f2cf.mp3",GetPVarFloat(playerid, "pBoomBoxX"),GetPVarFloat(playerid, "pBoomBoxY"),GetPVarFloat(playerid, "pBoomBoxZ"),50);
	        SendClientMessage(playerid, COLOR_YELLOW, "Ban da chon bai hat Ba thang ban");
	    }
	    if(listitem == 3)
	    {
		 	//Bai hat 3
		 	SendAudioURLToRange("http://stream2.s3.mp3.zdn.vn/fsfsdfdsfdserwrwq3/a569962ceccbb4c56b7e49d7a0b702ed/519aa6cb/2011/11/24/6/b/6b08d4b4b6fce8fbc60c551b310cb61f.mp3",GetPVarFloat(playerid, "pBoomBoxX"),GetPVarFloat(playerid, "pBoomBoxY"),GetPVarFloat(playerid, "pBoomBoxZ"),50);
	        SendClientMessage(playerid, COLOR_YELLOW, "Ban da chon bai hat Tra gia");
	    }
	    if(listitem == 4)
	    {
		 	//Bai hat 4
		 	SendAudioURLToRange("http://stream2.s1.mp3.zdn.vn/fsfsdfdsfdserwrwq3/460f158d6ef54bce5e9452551993fe10/519aa774/2011/11/24/0/f/0fe216e525f9e664b054a522733af296.mp3",GetPVarFloat(playerid, "pBoomBoxX"),GetPVarFloat(playerid, "pBoomBoxY"),GetPVarFloat(playerid, "pBoomBoxZ"),50);
	        SendClientMessage(playerid, COLOR_YELLOW, "Ban da chon bai hat Nguoi ngoai cuoc");
	    }
	    if(listitem == 5)
	    {
		 	//Bai hat 5
		 	SendAudioURLToRange("http://music-hcm.24hstatic.com/uploadmusic2/62566d50a89a27a5daff0945c6f8abf0/519a8fc3/uploadmusic/id_chan/2-2013/huylun/Rap/NewTrack/128/Dem%20Tan%20%20-%20Wowy.mp3",GetPVarFloat(playerid, "pBoomBoxX"),GetPVarFloat(playerid, "pBoomBoxY"),GetPVarFloat(playerid, "pBoomBoxZ"),50);
	        SendClientMessage(playerid, COLOR_YELLOW, "Ban da chon bai hat Dem tan");
	    }
	    if(listitem == 6)
	    {
		 	//Bai hat 6
		 	SendAudioURLToRange("http://s82.stream.nixcdn.com/49aab3a681faf021fc7aa996e4c9e943/519aa3bc/NhacCuaTui827/HeartAttack-DemiLovato-2415306.mp3",GetPVarFloat(playerid, "pBoomBoxX"),GetPVarFloat(playerid, "pBoomBoxY"),GetPVarFloat(playerid, "pBoomBoxZ"),50);
	        SendClientMessage(playerid, COLOR_YELLOW, "Ban da chon bai hat Heart Attack");
	    }
	    if(listitem == 7)
	    {
		 	//Bai hat 7
		 	SendAudioURLToRange("http://s91.stream.nixcdn.com/f326bc8688d53518451838f956c5214f/519aa3bc/NhacCuaTui004/NumaNuma-Dangcapnhat_34tp.mp3",GetPVarFloat(playerid, "pBoomBoxX"),GetPVarFloat(playerid, "pBoomBoxY"),GetPVarFloat(playerid, "pBoomBoxZ"),50);
	        SendClientMessage(playerid, COLOR_YELLOW, "Ban da chon bai hat Numa Numa");
	    }
	    if(listitem == 8)
	    {
		 	//Bai hat 8
		 	SendAudioURLToRange("http://stream4.mp3.zdn.vn/ES3stAYFQh/10deb9a3d150b808226bb6b0bb2b3c2e/519aaa64/2013/03/02/3/4/34086eaaa7fc9938249bcce7de8ff89e.mp3",GetPVarFloat(playerid, "pBoomBoxX"),GetPVarFloat(playerid, "pBoomBoxY"),GetPVarFloat(playerid, "pBoomBoxZ"),50);
	        SendClientMessage(playerid, COLOR_YELLOW, "Ban da chon bai hat Lrn ls lrn");
	    }
	    if(listitem == 9)
	    {
		 	//Bai hat 9
		 	SendAudioURLToRange("http://stream2.s1.mp3.zdn.vn/fsfsdfdsfdserwrwq3/edb46ac277488fab3065149158435d1c/519aaacb/2013/02/23/7/f/7f1eeadfbb70dce8bdd2acbd0e80267c.mp3",GetPVarFloat(playerid, "pBoomBoxX"),GetPVarFloat(playerid, "pBoomBoxY"),GetPVarFloat(playerid, "pBoomBoxZ"),50);
	        SendClientMessage(playerid, COLOR_YELLOW, "Ban da chon bai hat Harlem Shake");
	    }
	...
	if(dialogid == TIMVIECLAM)
	{
	    if(response)
	    {
	       	if(listitem == 0) // Tham Tu
		    {
				...
				SetPVarInt(playerid, "GiaoTraiCay_", 0);
			    DeletePVar(playerid, "GiaoTraiCay_");
			    
			    SetPVarInt(playerid, "GiaoBaoDz", 0);
	        	SetPVarInt(playerid, "HienDangGiao", 0);
				DaLayTraiCay[playerid] = 0;
	
				PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -1605.5110,710.4286,13.8672, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
		    ...
		    if(listitem == 2) //Gai Diem
		    {
				...
				PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -2241.2124,99.0769,35.3203, 3.0);
                CP[playerid] = 252000;
                return 1;
			}
			if(listitem == 3) //Buon Thuoc Phien
		    {
				...
				PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -1719.0361,-58.1230,3.5547, 3.0);
                CP[playerid] = 252000;
                return 1;
			}
			if(listitem == 4) //Ve si
		    {
				...
				PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -2269.8293,-155.9641,35.3203, 3.0);
                CP[playerid] = 252000;
                return 1;
			}
			...
			if(listitem == 6) //Buon Vu khi
		    {
				...
				PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -2623.333984, 209.235931, 4.684767, 3.0);
                CP[playerid] = 252000;
                return 1;
			}
			if(listitem == 7) //Vo si
			...
			if(listitem == 8) // Tai Xe Taxi
		    {
				...
				PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -1981.144775, 133.063293, 27.687500, 3.0);
                CP[playerid] = 252000;
                return 1;
			}
			if(listitem == 9) // Van chuyen thuoc phien
		    {
				...
				PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -1724.8787,-51.4448,3.5547, 3.0);
                CP[playerid] = 252000;
                return 1;
			}
			if(listitem == 10) // Tho Thu Cong
		    {
				...
				PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -2242.9236,136.8916,35.3203, 3.0);
                CP[playerid] = 252000;
                return 1;
			}
			if(listitem == 11) // Nguoi pha ruou
		    {
				...
				PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -2425.3755,337.4491,37.0018, 3.0);
                CP[playerid] = 252000;
                return 1;
			}
			...
			if(listitem == 13) //Trucker
			{
			    ...
			    PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -1559.7135,123.8775,3.5547, 3.0);
				CP[playerid] = 252000;
                return 1;
			}
			if(listitem == 14) //NGU DAN
			{
			    PizzaCP[playerid] = 0;
			...
			if(listitem == 15) //Giao Bao
			{
			    ...
			    PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -2240.3701,264.9971,35.3203, 3.0);
				CP[playerid] = 252000;
                return 1;
			}
			if(listitem == 16) //GIAO TRAI CAY
			{
			    PizzaCP[playerid] = 0;
			    ...
			    PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -2520.9775,-22.5278,25.6172, 3.0);
				CP[playerid] = 252000;
                return 1;
			}
			if(listitem == 17) // Tho Moc
			{
			    PizzaCP[playerid] = 0;
			    ...
			    PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -439.0679,-60.1274,58.9404, 3.0);
				CP[playerid] = 252000;
                return 1;
			}
			if(listitem == 18) //Van chuyen xang dau
			{
			    PizzaCP[playerid] = 0;
			    ...
			    PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -1702.5435,393.6020,7.1797, 3.0);
				CP[playerid] = 252000;
                return 1;
			}
			if(listitem == 19) //Nong Dan
			{
			    PizzaCP[playerid] = 0;
			    ...
			    PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -1061.3528,-1205.5302,129.7565, 3.0);
				CP[playerid] = 252000;
                return 1;
			}
			if(listitem == 20) //Nong Dan
			{
			    PizzaCP[playerid] = 0;
			    ...
			    PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, 598.3290,862.5349,-42.9609, 3.0);
				CP[playerid] = 252000;
                return 1;
			}
			if(listitem == 21) //giam sat dau khi
			{
			    PizzaCP[playerid] = 0;
			    ...
			    PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, 586.2943,1222.1500,11.7113, 3.0);
				CP[playerid] = 252000;
                return 1;
			}
			if(listitem == 22) //don rac
			{
			    PizzaCP[playerid] = 0;
				...
				PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -1871.5604,-208.8143,18.3834, 3.0);
				CP[playerid] = 252000;
                return 1;
			}
		}
	...
	if(dialogid == TIMDUONG)
	{
	    if(response)
	    {
            if(listitem == 0) // HQ VIP
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -2439.2588,502.7974,29.9454, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 1) // 24/7
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -2443.3450,749.0101,35.1719, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 2) // Shop gun
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -2626.3958,211.6604,4.6043, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 3) // Noi sua xe 1
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -2712.7639,216.9926,4.2413, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 4) // Noi sua xe 2
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -1904.7452,273.7173,41.0469, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 5) // Noi sua xe 3
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -2425.8684,1032.7888,50.3906, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 6) // Cua hang xe 1
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -1971.3778,294.3987,35.1719, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 7) // Cua hang xe 2
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, 1481.0742, -1741.6619, 16.1753, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 8) // Noi do xe
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -1936.2416,234.7369,34.3125, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 9) // Benh vien
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -2656.1567,607.4576,14.4531, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 10) // San Bay
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -1689.1377,-569.9346,12.9836, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 11) // Cua Hang Quoc Ao
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -1886.2394,863.1108,35.1728, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 12) // Giao Vat Lieu
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -1822.6182,-176.3025,9.3984, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 13) // Cau Do
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -2681.1809,1254.5701,55.6892, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 14) // Noi Hai Can Sa
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -680.2183,983.0388,12.1262, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 15) // Noi Ban Can Sa
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -2662.4277,234.6164,4.3416, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 16) // SFPD
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -1604.9237,717.0672,11.8711, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 17) // SAAS
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -1533.5681,490.8093,7.1797, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 18) // DoC
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -2046.5265,-87.0239,35.1641, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 19) // TRAF
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -2340.9539,2479.4092,4.9822, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 20) // SANews
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -2121.2896,208.0587,35.3300, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 21) // Bank
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -1579.9491,909.8611,7.6953, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
			if(listitem == 22) // ban kim cuong
		    {
		        PlayerPlaySound(playerid, 1056, 0.0, 0.0, 0.0);
				SetPlayerCheckpoint(playerid, -2158.7534, -264.4915, 34.1267, 3.0);
                CP[playerid] = 252000;
				return 1;
			}
	    }
	...
	if(RegistrationStep[playerid] != 0 || strcmp(PlayerInfo[playerid][pBirthDate], "0000-00-00", true) == 0)
	{
		...
		else if(dialogid == REGISTERREF)
		{
		    if(response)
		    {
				...
				PlayerInfo[playerid][pVehicleSlot] = 20;
				...
				PlayerInfo[playerid][pVIPExpire] = gettime()+1296000;
				...
				GameTextForPlayer(playerid, "~y~Welcome to San Andreas...", 5000, 3);
				SendClientMessage(playerid, COLOR_YELLOW, "Neu ban khong hieu hay gap bat cu loi gi vui long lien he : /baocao");
				...
				SetPlayerPos(playerid, -1726.9319,1355.9238,7.1875);
				SetPlayerFacingAngle(playerid, 117.6180);
				SetCameraBehindPlayer(playerid);
				SetPlayerVirtualWorld(playerid, 0);
				//_____________________________________________________________
			}
	...
	switch(dialogid)
	{
		...
		case DIALOG_EDITGROUP: {
			...
			if(response) switch(listitem) {
				...
				case 18: {
					...
					ShowPlayerDialog(playerid, DIALOG_GROUP_EDITSTOCK, DIALOG_STYLE_INPUT, szTitle, "Specify a value. Locker stock is used for weapons, and can be replenished using crates.", "Dong y", "Huy bo");
				}
				case 19: {
				...
				default: {
					...
					This action will {FF0000}delete all group data and remove all members and leaders{FFFFFF} from the group, whether online or offline.", "Cancel", "Dong y");
				}
			}
		...
		case DIALOG_GROUP_DUTYCOL: {
			...
			if(response) {
				...
				if(strlen(inputtext) > 6 || !ishex(inputtext)) {
					...
					return ShowPlayerDialog(playerid, DIALOG_GROUP_DUTYCOL, DIALOG_STYLE_INPUT, szTitle, "Invalid value specified.\n\nEnter a colour in hexadecimal format (for example, BCA3FF). This colour will be used to identify the group.", "Dong y", "Huy bo");
				}
		...
		case DIALOG_GROUP_RADIOCOL: {
			...
			if(response) {
				...
				if(strlen(inputtext) > 6 || !ishex(inputtext)) {
					...
					return ShowPlayerDialog(playerid, DIALOG_GROUP_RADIOCOL, DIALOG_STYLE_INPUT, szTitle, "Invalid value specified.\n\nEnter a colour in hexadecimal format (for example, BCA3FF). This colour will be used for the group's in-character radio chat.", "Dong y", "Huy bo");
				}
				sscanf(inputtext, "h", hColour);
		...
		case DIALOG_GROUP_EDITDIVS: {
			...
			if(response) {
				...
				return ShowPlayerDialog(playerid, DIALOG_GROUP_EDITDIV, DIALOG_STYLE_INPUT, szTitle, "Specify a division name (or none to disable it).", "Dong y", "Huy bo");
			}
			return Group_DisplayDialog(playerid, iGroupID);
		}
		...
		case DIALOG_GROUP_LOCKERS: {
			...
			if(response)
			{
				...
				{
					ShowPlayerDialog(playerid, DIALOG_GROUP_LOCKERDELETECONF, DIALOG_STYLE_MSGBOX, szTitle, "{FFFFFF}Are you sure you want to delete ALL of the lockers for this group?", "Cancel", "Dong y");
					return 1;
				}
				else
				{
		...
		case DIALOG_GROUP_EDITRANKS: {
			...
			if(response) {
				...
				return ShowPlayerDialog(playerid, DIALOG_GROUP_EDITRANK, DIALOG_STYLE_INPUT, szTitle, "Specify a rank name (or none to disable it).", "Dong y", "Huy bo");
			}
			return Group_DisplayDialog(playerid, iGroupID);
		}
		...
		if(response)
		{
			...
			if(listitem == 2)
			{
				if(PlayerInfo[playerid][pDonateRank] >= 1)
				{
					...
					{
						case 1, 2: ShowPlayerDialog(playerid, VIPWEPSMENU, DIALOG_STYLE_LIST, "Vu khi VIP", "Shotgun (2)\nMP5 (3)\nSilenced Pistol (2)\nGolf Club (1)\nBat (1)\nDildo (1)\nSword (1)", "Lua chon", "Huy bo");
						default: ShowPlayerDialog(playerid, VIPWEPSMENU, DIALOG_STYLE_LIST, "Vu khi VIP", "Shotgun\nMP5\nSilenced Pistol\nGolf Club\nBat\nDildo\nSword", "Lua chon", "Huy bo");
					}
				}
				else
				{
			...
			if(listitem == 6)
			{
			    ShowPlayerDialog(playerid, SKINCUSTOM, DIALOG_STYLE_LIST, "Skin Custom", "2B\nGaren\nGoku Akatsuki\nKirito\nSasuke\nLuffy\nMiku\nOne Punch Man\nShiro\nYasuo", "Lua chon", "Thoat");
			}			
		}
	}
	if(dialogid == SKINCUSTOM) //This is now the default dialog for job centers in any lockers AKA VIP & Famed
	{
	    if(!response) return 1;
	    switch(listitem)
	    {
	        case 0: // 2B
	        {
				...
				PlayerInfo[playerid][pModel] = 20001;
			}
	        case 1: // Garen
	        {
				SetPlayerSkin(playerid, 20002);
				PlayerInfo[playerid][pModel] = 20002;
	        }
	        case 2: // Goku Akatsuki
	        {
				SetPlayerSkin(playerid, 20003);
				PlayerInfo[playerid][pModel] = 20003;
	        }
	        case 3: // Kirito
	        {
				SetPlayerSkin(playerid, 20004);
				PlayerInfo[playerid][pModel] = 20004;
	        }
	        case 4: // Levi
	        {
	      		SetPlayerSkin(playerid, 20005);
				PlayerInfo[playerid][pModel] = 20005;
	        }
	        case 5: // Luffy
	        {
	            SetPlayerSkin(playerid, 20006);
				PlayerInfo[playerid][pModel] = 20006;
	        }
	        case 6: // Miku
	        {
	            SetPlayerSkin(playerid, 20007);
				PlayerInfo[playerid][pModel] = 20007;
	        }
	        case 7: // One Punch Man
	        {
	            SetPlayerSkin(playerid, 20008);
				PlayerInfo[playerid][pModel] = 20008;
	        }
	        case 8: // Shiro
	        {
	            SetPlayerSkin(playerid, 20009);
				PlayerInfo[playerid][pModel] = 20009;
	        }
	        case 9: // Yasuo
	        {
	            SetPlayerSkin(playerid, 20010);
				PlayerInfo[playerid][pModel] = 20010;
			}
	    }
	}
	...
	if(dialogid == RESTAURANTMENU)
	{
	    ...
	    if (response)
	    {
			...
			if (!iPrice) {
				...
				SendClientMessage(playerid, COLOR_GRAD2, string);
				SetPlayerHealth(playerid, 100.0);
				new doibung = 10+random(20);
				new khatnuoc = 15+random(20);
				
				if(PlayerInfo[playerid][pDoiBung] < 100)
				{
				    PlayerInfo[playerid][pDoiBung] += doibung;
				}else PlayerInfo[playerid][pDoiBung] = 100;
				
				if(PlayerInfo[playerid][pKhatNuoc] < 100)
				{
				    PlayerInfo[playerid][pKhatNuoc] += khatnuoc;
				}else PlayerInfo[playerid][pKhatNuoc] = 100;
...
/*	if(dialogid == MDC_CHECK && response)
	...
	if(dialogid == DIALOG_JFINECONFIRM)
	{
		if(response)
		{
			...
			ShowPlayerDialog(playerid, DIALOG_JFINE, DIALOG_STYLE_MSGBOX, "Judge Fine - Confirm", string, "Dong y", "Huy bo");
		}
		else {
	...
	if(dialogid == DRINKLISTDIALOG)
	{
	    if(response)
	    {
			...
			if(GetPlayerCash(playerid) >= GetPVarInt(playerid, "DrinkPrice"))
			{
			    ...
			    format(string, sizeof(string), "Ban da goi mot chai %s voi' so tien $%d.  Do you want to tip the bartender?", drinkname, drinkprice);
			    ShowPlayerDialog(playerid, DRINKDIALOG, DIALOG_STYLE_MSGBOX, "Drink Purchase", string, "Yes", "No");
			    format(string, sizeof(string), "* %s rot' cho %s mot it %s va chuyen cho cau ta.", GetPlayerNameEx(DrinkOffer[playerid]), GetPlayerNameEx(playerid), drinkname);
				...
				if(drinkprice >= 25000 && (PlayerInfo[DrinkOffer[playerid]][pLevel] <= 3 || PlayerInfo[DrinkOffer[playerid]][pLevel] <= 3))
				{
					...
					Log("logs/tratien.log", string);
					ABroadCast(COLOR_YELLOW, string, 2);
				}
			}
			else
			{
			    SendClientMessageEx(playerid, COLOR_LIGHTBLUE, "* Ban khong co du tien cho thuc uong nay!");
			}
	    }
	    else
	    {
	...
	else if(dialogid == SETSTATION)
	{
	    if(response)
	    {
			if(listitem == 0)
			{
	        	...
	        	{
	        		SetPVarInt(playerid, "pHTTPWait", 1);  /// y' dc hay sao a vcl
	...
	else if(dialogid == DIALOG_LOADTRUCKOLD) // TRUCKER JOB LOAD TRUCK
	{
 		if(response)
		{
			...
			if(listitem == 1) // Illegal goods
			{
				...
				if(level >= 0 && level <= 50)
				{
            		ShowPlayerDialog(playerid, DIALOG_LOADTRUCKI, DIALOG_STYLE_LIST, "Ban muon van chuyen gi?","{FF0606}Vu khi  		{FFFFFF}(Level 1 Bonus: Free Baseball Bat)\n{FF0606}Drugs 			{FFFFFF}(Level 1 Bonus: Free 2 pot, 1 crack)\n{FF0606}Illegal materials  	{FFFFFF}(Level 1 Bonus: Free 500 materials)", "Lua chon", "Thoat");
				}
				else if(level >= 51 && level <= 100)
				{
		    		ShowPlayerDialog(playerid, DIALOG_LOADTRUCKI, DIALOG_STYLE_LIST, "Ban muon van chuyen gi?","{FF0606}Vu khi  		{FFFFFF}(Level 2 Bonus: Free Golf club)\n{FF0606}Drugs 			{FFFFFF}(Level 2 Bonus: Free 4 pot, 2 crack)\n{FF0606}Illegal materials  	{FFFFFF}(Level 2 Bonus: Free 1000 materials)", "Lua chon", "Thoat");
				}
				else if(level >= 101 && level <= 200)
				{
		    		ShowPlayerDialog(playerid, DIALOG_LOADTRUCKI, DIALOG_STYLE_LIST, "Ban muon van chuyen gi?","{FF0606}Vu khi  		{FFFFFF}(Level 3 Bonus: Free Katana)\n{FF0606}Drugs 			{FFFFFF}(Level 3 Bonus: Free 6 pot, 3 crack)\n{FF0606}Illegal materials  	{FFFFFF}(Level 3 Bonus: Free 1500 materials)", "Lua chon", "Thoat");
				}
				else if(level >= 201 && level <= 400)
				{
            		ShowPlayerDialog(playerid, DIALOG_LOADTRUCKI, DIALOG_STYLE_LIST, "Ban muon van chuyen gi?","{FF0606}Vu khi  		{FFFFFF}(Level 4 Bonus: Free 9mm Pistol)\n{FF0606}Drugs 			{FFFFFF}(Level 4 Bonus: Free 8 pot, 4 crack)\n{FF0606}Illegal materials  	{FFFFFF}(Level 4 Bonus: Free 2000 materials)", "Lua chon", "Thoat");
				}
				else if(level >= 401)
				{
 		 			ShowPlayerDialog(playerid, DIALOG_LOADTRUCKI, DIALOG_STYLE_LIST, "Ban muon van chuyen gi?","{FF0606}Vu khi  		{FFFFFF}(Level 5 Bonus: Free Silenced pistol)\n{FF0606}Drugs 			{FFFFFF}(Level 5 Bonus: Free 10 pot, 5 crack)\n{FF0606}Illegal materials  	{FFFFFF}(Level 5 Bonus: Free 2500 materials)", "Lua chon", "Thoat");
				}
			}
		}
		else
	...
	else if(dialogid == DIALOG_AUCTIONS2)
	{
	    if(response) {
			...
			if(Auctions[AuctionItem][InProgress] == 1) {
				...
				format(DaugiaInfo, sizeof(DaugiaInfo), "Ban dang dau thau tren %s. Gia thau hien tai la $%i, dat mot gia thau cao va duy nhat o thoi diem hien tai.", Auctions[AuctionItem][BiddingFor], Auctions[AuctionItem][Bid]);
			    ShowPlayerDialog(playerid, DIALOG_AUCTIONS3, DIALOG_STYLE_INPUT, "Dau gia-Dau thau",DaugiaInfo,"Dat thau","Thoat");
			}
			else {
	...
	if (dialogid == SPEEDCAM_DIALOG_LIMIT)
	{
		...
		ShowPlayerDialog(playerid, SPEEDCAM_DIALOG_OVERVIEW, DIALOG_STYLE_MSGBOX, "{FFFF00}Speed camera overview", content, "Dong y", "Huy bo");
	}
	...
	if(dialogid == DIALOG_VOUCHER)
	{
		if(response)
		{
			...
			if(listitem == 3) // PVIP Voucher
			{
				...
				ShowPlayerDialog(playerid, DIALOG_PVIPVOUCHER, DIALOG_STYLE_MSGBOX, "Platinum VIP Voucher", "You will be made Platinum VIP after use of this voucher.", "Dong y", "Huy bo");
			}
