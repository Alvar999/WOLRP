...
CMD:codetwo(playerid, params[])
    {
        ...
        if(!Flasher[vehicleid]) {
                ...
                {
                        return SendClientMessage(playerid, -1, "ban phai o trong xe");
                }
                if (!GetVehicleModel(vehicleid)) return SendClientMessage(playerid, -1, "ban phai o trong xe");
                ...
                {
                        SendClientMessage(playerid, -1, "tao chiu."), DestroyObject(obj[vehicleid]), DestroyObject(obj2[vehicleid]), DestroyObject(obj3[vehicleid]), DestroyObject(obj4[vehicleid]), DestroyObject(obj5[vehicleid]);
